...
<![endif]-->
<title>Chem-oMania|Equilibrio 2k17</title>
...
background:url(parallax/css/images/chemo1.png) no-repeat;}
.planet2{
background:url(parallax/css/images/chemo2.png) no-repeat;}
    </style>
...
<p>This event consist of two rounds based on basic engineering knowledge hence every student can participate.There should not be more than three members in a team.
<h4>ROUND 1- PLAY BUZZ</h4>
 Description-This is basically a science Quiz involving questions based on general science and basic engineering aspects.this round has 30% weightage.
 <h4>ROUND 2 - LAMINOZZLE</h4>

Description-Laminar flow nozzle sounds quite complex but it's actually just a myth.it is an innovative nozzle, which applies simple and reliable mechanism to create laminar flow out of turbulent. It is consist of pvc pipe, straws, scrubbers etc.this round will have 70% weightage
...
<p><h4>Round 1 Rules</h4>
<ol>
<li>
Five questions will be asked from each team.For every question 30sec will be given after which question will pass to next team.</li><br>
<li>For every right answer 1 marks will be provided.</li><br>
<li>Negative marking of ½ marks will be there for every wrong answer.</li><br>
<li>Team can pass their question.which will become bonus question for  next team.</li><br>
<li>1/2 marks will be provided for every right answer of bonus question.</li><br>
<li>All team will be qualified for second round,no knockout in first round.
 </li>
...
<p><h4>Round 2 Rules</h4>
<ol>
<li> The out coming jet should be fine laminar.</li><br>
<li> The jet should not shake itself.</li><br>
<li> It should cover maximum distance.</li><br>
<li>Team can pass their question.which will become bonus question for  next team.</li><br>
<li>1/2 marks will be provided for every right answer of bonus question.</li><br>
<li>All team will be qualified for second round,no knockout in first round.
 </li><br>
<li>In case all above points are same then <ul>
<li> Concept used</li><li>
Construction</li></ul>
...
<ol><li>
Final winner will be decided on basis of grand total of both rounds.

</li><br>
<li>In case Tie, second round will be consider as deciding round.</li><br>
...
<div class="pull-left">
<img class="img-responsive img-circle" src="assets/img/team/head/mania.jpg">
</div>
<div class="media-body"><br>
<h3 style="color:#fff;margin-left:10px">Shashank Srivastav </h3>
<h4 style="color:#fff;margin-left:10px">Ph no. 9044758700</h4>
</div>
</div>
...
$num = mysqli_num_rows(mysqli_query($con,"SELECT * FROM mania"));
echo $num;
 ?>
<small>in this event</small>
</div>
