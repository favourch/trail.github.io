...
<![endif]-->
<title>Debug The Code|Equilibrio 2k18</title>
...
<li class=""><a href="#tab5" data-toggle="tab" class="tehnical">Credit Criteria</a></li>
...
<p>
“DISCOVERING THE UNEXPECTED IS MORE IMPORTANT THAN CONFIRMING THE KNOWN.<br>
 DON’T JUST DOCUMENT THE BUG,FIX IT !!!”<br>
It’s a game of mind & time. It’s not just about finding the flaws & fixing it. It’s about running your mind quickly & testing it, to test the code.
Dive deeper, ponder hard, to fix the bugs & discover your tester mind, running far in short time.
</p>
...
<p><H3>RULES AND REGULATION</H3><br>
<h3>Format Specifications: </h3>The event consists of two rounds.<br>
<br><h3>Team Size:</h3>Maximum 2 members are allowed in a team.
</div>

<div class="tab-pane fade" id="tab3">
<h3>Round 1 (AVIVAR ROUND)</h3>
<p><ol><li>
Each team will be provided 7 programs.</li><br><li>
First 4 programs will have maximum 2 compiler error & teams will be given 3 mins time to fix it.</li><br><li>
The next 3 questions will have 2 compiler error & atmost 1 logical error, & teams will be given 4 mins to fix it.</li><br><li>
For each program, maximum two compilation is allowed.</li></ol></p>
</div>

<div class="tab-pane fade" id="tab4">
<h3>Round 2 (STAR WAR)</h3>
<p><ol>
<li>Each team will be provided 5 programs.</li><br><li>
First 3 questions will have 1 logical error & atmost 1 compiler error & teams will be given 5 mins to fix it.</li><br><li>
The next 2 questions will have 2 logical error & atmost 2 compiler error & teams will be given 7 mins to fix it.</li><br><li>
...
<h3>
CREDIT CRITERIA<h3><p>
Extra credit points will be awarded to the team bringing out the desired output in less than half of the time limit. <br><br>
Credits would be deducted with each unsuccessful compilation.</p>
</div>
...
<h3 style="color:#fff;margin-left:10px">SHUBHAM SINGH</h3>

<h4 style="color:#fff;margin-left:10px">Ph no. 8052454659</h4>
</div>
</div>
...
$num = mysqli_num_rows(mysqli_query($con,"SELECT * FROM dbg"));
echo $num;
 ?>
<small>in this event</small>
</div>
