...
<![endif]-->
<title>LogicLeague|Equilibrio 2k17</title>
...
This event will be completely based on the logical gates. In first round we will ask some general questions about Logical Gates. The Best four teams of round 1 will enter in the final round.<br> <br>In final round we will provide logical gates to the team and will give them a specific task to do. Team who perform the task in minimum time will be declared as a winner.
<br><br>At max 2 members are allowed in a team.<br><br>There will be 2 rounds.
</div>
</div>
</div>
...
<ol><li>Each correct answer will give 3 Marks.</li><br>
<li>Each wrong answer will give -1 Marks.</li><br>
<li>Level Of questions is- 10 easy type, 15 medium and 5 tough.</li><br>
<li>If there is a tie b/w teams in round 1, the one who register earlier will be promoted to next round</li><br>
<li>For question having more than one answer there will be partial marking.</li><br>
<li>Only the best five team will qualify for round 2.</li><br>
</ol>
...
<p>
<h3>ROUND 2</h3>
In this round participants will do practical like thing to get desired output.
It consist of digital circuit designing . Question are display on screen through projector. Questions are based on daily life problem and contestant have to design the solution circuit for particular problem.<br><br>

<ol><li>It will be a knockout round(On Time Basis)</li><br>
<li> The team who stand last will be declared as a winner.</li><br>
<li>Only two winners will be selected for 1st and 2nd position only.</li><br>
<li>If there is tie up between any two teams then rematch will be organised between them</li><br>
...
<div class="media-body">
<h3 style="color:#fff;margin-left:10px">Amit Kumar Singh</h3>
<h4 style="color:#fff;margin-left:10px">Ph no. 9456233564</h4>
</div>
</div>
...
$fh1 = fopen("logicleague1.txt", 'r+') or
...
$num = mysqli_num_rows(mysqli_query($con,"SELECT * FROM logicleague"));
echo $num;
 ?>
<small>in this event</small>
</div>
