...
<![endif]-->
<title>DesignEr|Equilibrio 2k17</title>
...
background:url(parallax/css/images/designer1.png) no-repeat;}
.planet2{
background:url(parallax/css/images/designer2.png) no-repeat;}
    </style>
...
<li class=""><a href="#tab3" data-toggle="tab" class="tehnical">Round 1</a></li>
<li class=""><a href="#tab4" data-toggle="tab" class="tehnical">Round 2</a></li>
...
<h4>Description</h4>
<ul><li>
There will be two stages in this event: Round 1 & Round 2. <br>Objective of first round is to test the ability of the participants in working with the CAD software and designing the simple solid models in the software.</li><br>
<li>All the teams will be allowed in the Round 1 after which about one-third of them will be selected for the next stage Round 2. </li><br>

<li>Before starting of each Round respective Problem Statement Sheets will be distributed to teams, and after the time is up they have to submit their models in the described file formats.</li><br>
<li>Participating teams are required to bring their own computer system (laptop, mouse, track-pad etc) in fully working condition and with appropriate battery charge status. <br>In case of not working of computer or battery drain-out, no concession will be given and eventually it will lead to their disqualification.  </li><br>
</ul>
</div>
</div>
</div>
...
<p>
<ol><li>
 All participants have to bring their own laptop, mouse etc. Participants will be responsible for working condition of their system.</li><br>
<li> Given design have to be made in CATIA, Pro-E, solid woks, AutoCAD and other software for which workshop would be done.</li><br>
  <li>After Completing their design they have to submit the files in following four formats<br>
  <ul><li>
 Default format of the files depending on the software they have used and the workbench(s) used in designing the model.</li>
<li> Three more CAD file formats, .step, .igs & .stl.</li>
...
<p><H3>ROUND 1</H3>
<ol><li>
Number of Members in a team <br>For 1st& 2nd year : 2 persons, 2 computers<br>
Others : 1 person, 1 computer</li><br>
<li>Task : Make as much models as you can within given period of time.</li><br>
<li>Number of parts to be made : As much as you can out of given ten part models.</li><br>
<li>Total time : 30 minutes.</li><br>
<li>Problem will be presented in : 2D sketch containing different normal views and one isometric view.</li><br>
...
Number of Members in a team <br>For 1st& 2nd year: 2 persons, 2 computers<br>
Others : 1 person, 1 computer</li><br>
<li>Task : Design the required assembly given in problem statement.</li><br>
<li>No. of assemblies to made : One</li><br>
<li>Time : 100 minutes.</li><br
<li>Problem will be presented in : Two formats<ul><li>
 Problem Statement in text describing aim and function of the assembly.</li><br>
<li> 2-D sketches of parts containing isometrics and projection views.</li><br>
</li><br>
...
<div class="media-body">
<h3 style="color:#fff;margin-left:10px">Gunja Kumari </h3>
<h4 style="color:#fff;margin-left:10px">Ph no. 7898984634</h4>
</div>
</div>
...
$num = mysqli_num_rows(mysqli_query($con,"SELECT * FROM designer"));
echo $num;
 ?>
<small>in this event</small>
</div>
