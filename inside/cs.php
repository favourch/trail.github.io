...
<![endif]-->
<title>CS|Equilibrio 2k17</title>
...
<li class=""><a href="#tab3" data-toggle="tab" class="tehnical">Map Pools</a></li>
...
<p>Counter strike is the most famous and frequently played game in electronic sports in First Person Shooting (FPS) category. <br><br>Teams compete for proving themselves as “The Best”.<br> The tournament follows knockdown format, in which two teams from all registered participants will compete at time and the winner progresses on the path of Glory! In the end, one team will survive and will win.</p><br>
<h4>BASIC RULES</h4>
<ul>
...
<p>
<ol>
<li>Competition Method: 4 vs 4 (team play,4 players per team)</li><br>
<li>Version:Counter Strike Source</li><br>
<li>Round time: 1 minute 45 seconds</li><br>
<li>The team playing as the terrorist side first will be announced before the match by a toss</li><br>
<li>Maps will be given on spot</li><br>
<li>Approved grenade amounts per round  
<ul><li>Flash bangs:2</li>
<li>Grenades:1</li>
<li>Smoke grenades:1</li></ul></li><br>
<li>Short guns,shields,automatic sniper are not allowed.</li><br>
<li>Any player or team caught breaking a rule or performing an infraction will be subject to disqualificaton</li><br>
<li>Cash of Rs.800 will be provided at the start.</li><br>
...
$num = mysqli_num_rows(mysqli_query($con,"SELECT * FROM counter"));
echo $num;
 ?>
<small>in this event</small>
</div>
