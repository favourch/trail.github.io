...
<![endif]-->
<title>Bizwhiz|Equilibrio 2k17</title>
...
<p>If business attracts you, logos excite you, and startups inspire you, then Bizwhiz is just the right stage to show off your corporate knowledge.
Business quiz tests your knowledge about this world of growing corporate companies, changing logos, exciting branding and marketing strategies.<br>
So charge up your business cells, participate and take head on with others at Bizwhiz.
 </p>
<br><br>
...
$num = mysqli_num_rows(mysqli_query($con,"SELECT * FROM bizwiz"));
echo $num;
 ?>
<small>in this event</small>
</div>
