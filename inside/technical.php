...
<![endif]-->
<title>Technical Quiz|Equilibrio 2k17</title>
...
background:url(parallax/css/images/quizzard1.png) no-repeat;}
.planet2{
background:url(parallax/css/images/quizzard2.png) no-repeat;}
    </style>
...
<li class=""><a href="#tab3" data-toggle="tab" class="tehnical">Prize</a></li>
</ul>
</div>
...
<p>Knowing the answer isn’t enough but the way you answer matters. Bringing this flow of analytical thinking into the field of quiz spiced up with lots of fun and technical knowledge is what Technical quiz aims at.</p><br>
If u think that technical quiz is great but boring to participate, this quiz can prove you wrong!!   <br><p>   
This quiz tests not only your ability to memorize important facts and events but also sees how much you really enjoy quizzing, throwing at you new challenges and puzzles at every step. 
So get ready, be prepared to be puzzled and witness the fun side of quizzing.

 </p>
<br><br>
<h4>Team size : Maximum 2 members </h4> 
...
<p><H4>RULES</H4>
<ol><li>There will be a written elimination test followed by a final round.</li><br>
<li>Each team will have a maximum of two participants.</li><br>
<li>Five teams will be selected for the final round.</li><br>
<li>2 teams will be selected -the winners and the runners-up respectively. The winners will be the team with maximum points at the end of 5th level.</li><br>
<li>The decision of quizmaster will be final in any case of disagreement by the teams. </li><br>
<li>Single participant will be allowed in the case of no teammate but changing of the team members after getting selected will naturally get the team disqualified.</li><br>
<li>The teams not reaching on time at the venue will be disqualified</li><br>
<li>The points and the rules related to the passing of questions and the tiebreaker will be decided by the quizmaster</li><br>
<li>The quiz committee will have the right to change any of the above stated rules if deemed fit.</li>
</ol>
</p>
</div>
...
<div class="pull-left">
<img class="img-responsive img-circle" src="assets/img/team/head/quiz.jpg">
</div>
<div class="media-body"><br>
<h3 style="color:#fff;margin-left:10px">Ajit Kumar</h3>

<h4 style="color:#fff;margin-left:10px">Ph no. 8985886557</h4>
</div>
</div>
...
$num = mysqli_num_rows(mysqli_query($con,"SELECT * FROM technical"));
echo $num;
 ?>
<small>in this event</small>
</div>
