...
<li class=""><a href="#tab4" data-toggle="tab" class="tehnical">Rules for Foul</a></li>
<li class=""><a href="#tab5" data-toggle="tab" class="tehnical">Disqualification</a></li>
...
<li>Teams will have to bring down the voltage less than 12 volts 2 amp.</li>
<li>The voltage at any point on the electrical connections should not exceed 12v.</li>
<li>Rechargable batteries are also allowed.</li>
<li>The wireless bot should have its own power supply.</li></ol>
...
<h3>GAME PLAY</h3>
<p>
<ol><li>Teams will have to play a football match against other team.</li>
<li>2:30 minutes will be provided for each team for pregame setup and testing.</li>
<li>The match will be of 15 minutes (two halves of 6 minutes and 3 minutes for maintenance.)</li>
<li>A defender block of dimension  10cm*5cm*5cm will be provided for each team which can be set at the initiation of each half by participating team members on defendive arc.</li>
<li>The game will be started on the count of three by the referee.teams making mistakes during start more than twice will be punished by -2 points.</li>
...
<li> The ball will be dragged, pushed or kicked by bot.</li>
...
<li>If a team member touch the bot during match, it will be considered as foul.</li><br>
...
<img src="assets/img/soccer.png" class="snakoarena">
</p>
</div>
...
<h3 style="color:#fff;margin-left:10px">KUMAR GAURAV</h3>
<h4 style="color:#fff;margin-left:10px">Ph no. 9098736535</h4>
</div>
</div>
...
$num = mysqli_num_rows(mysqli_query($con,"SELECT * FROM rso"));
echo $num;
 ?>
<small>in this event</small>
</div>
