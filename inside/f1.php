...
<![endif]-->
<title>F1|Equilibrio 2k17</title>
...
background:url(parallax/css/images/f11.png) no-repeat;}
.planet2{
background:url(parallax/css/images/f12.png) no-repeat;}
    </style>
...
<li><a href="#tab2" data-toggle="tab" class="analistic-02">Rules</a></li>
<li class=""><a href="#tab3" data-toggle="tab" class="tehnical">Machine Specs</a></li>
<li class=""><a href="#tab4" data-toggle="tab" class="tehnical">Rounds</a></li>
<li class=""><a href="#tab5" data-toggle="tab" class="tehnical">Abstract Submission</a></li>
<li class=""><a href="#tab6" data-toggle="tab" class="tehnical">Prize</a></li>
...
<p>  GEAR UP AND HOLD YOUR NERVES TIGHT,<br> THE SECOND SEASON OF “F1……UNLEASH THE BEAST” IS ON ITS WAY<br><br>
</p><br>
Make a wireless radio controlled machine, powered by an IC engine, which can race against other opponents on an off-road dirt track with many obstacles.<br>
<h4>Track specification:</h4>
<ul><li>Track is of 1.2mtrs, which contain even and uneven rough surfaces, with small size and large size hurdles and also sharp turns.</li>
<li>Track length is nearly about 130mtrs.</li>
</ul>
</div>
</div>
</div>
...
<p>
<ol><li>
The team will have a maximum of 5 students. </li>
<li>There will be a qualifying session with each team getting 3 laps out of which the faster lap will be considered.Note that these laps will have to be taken successively. </li>
<li>The top teams from the qualifying rounds will make it to the second round. </li>
<li> After the qualifying round, there will be races between multiple cars at a time. So the participants must use a remote with frequency of band spectrum 2.4 GHz. </li>
<li> The track will have check points at regular intervals. If a machine tumbles, halts or goes off the arena at any point on the track, one of the team members is allowed to lift it up and place it at the nearest checkpoint behind that point. The time shall still be running in the meantime. </li>
<li> Team members are not permitted to touch either their machines or those of their opponents once the race begins The penalty for doing so is disqualification </li>
<li> In the qualification round, a maximum of two team members are allowed from a team in the racing arena while in the final round only one of the team member will be in the racing arena except the controller on the stand. </li>
...
<li>Teams are not allowed to purposefully damage the machine of the opponent's team. If found doing so on track (while racing), the concerned team will be disqualified. </li>
<li> If car goes off the track i.e three wheels of the car are on the rope then should be brought back to the nearest checkpoint.</li>
...
<p>
<h4>MACHINE SPECS</h4>
<ol><li>Machine should fit in a box of dimensions 700mm x 500mm x 500mm at any moment of time during the race. The external device which is used to control the machine is not included in the size constraint. </li>
 <li>The machine should be controlled by a wireless remote control mechanism throughout the race (Band Spectrum around 2.4 GHz). </li>
 <li>The maximum allowed capacity of IC engine to be used is 4.6 cc. Lower engine capacity like 2.5 cc, 3 cc, 3.5 cc engines can also be used. </li>
...
<li> The IC engine is to be the sole source of power for propulsion purposes. DC Motors and Servos can be used for steering and any other control system used in the car. </li>
<li>The electric voltage anywhere in the machine should not exceed 12V at any point of time. </li>
<li> The machine must have an on-board power supply to run any mechanism requiring electric power. No external source of power will be provided to the participants at the time of the race. </li>
...
<p><H3>Qualifying Round</H3>
<ol><li>


The speed and braking attributes of the car would be put to test in this round. </li>
<li>Each team will be getting 3 laps out of which the faster lap will be considered. Note that these laps will have to be taken successively. </li>
<li>A car making two invalid attempts would undergo automatic disqualification. 
</li>
</ol><br>
<H3>Main/Second Round</H3>
<ol><li>
Main/second  round consists of parallel racing between two qualified cars.
</li>
<li>The format of the round would be knockout. Seeding system will be followed     while deciding the initial draw. The draw would be based on the first round ranking. </li>
<li>No of cars competing each time will be revealed before the race.  
</li>
<li> Each race would be of 3 laps. Cars successfully finishing all the three laps will be considered as completed. 
 </li>
</ol><br>
</p>
</div>
...
<ol><li>
The abstract should contain the description of your nitro car including all its specifications.</li><br>
<li>Kindly keep your explanations short and to the point.</li><br>
<li>The abstract may be in .doc or .pdf format.</li><br>
<li>It may also contain the pictures of the machine and also preferably a video of the working module.
</li><br>
<li>It should also denote the team name with the members of the team. </li><br>
<li>The specifications of all the components used, including engine, suspension springs, remote controller etc. have to be mentioned.
</li><br>
<li>The abstract should be submitted to the organising team through mail to saikiranchintu786@gmail.com</li><br>
...
<div class="pull-left">
<img class="img-responsive img-circle" src="assets/img/team/head/f1.jpg">
</div>
<div class="media-body"><br>
<h3 style="color:#fff;margin-left:10px">S.Sai Kiran</h3>

<h4 style="color:#fff;margin-left:10px">Ph no. 8332089834</h4>
</div>
</div>
...
$num = mysqli_num_rows(mysqli_query($con,"SELECT * FROM f1race"));
echo $num;
 ?>
<small>in this event</small>
</div>
