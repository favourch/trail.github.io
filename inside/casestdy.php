...
<![endif]-->
<title>Case Study|Equilibrio 2k18</title>
...
<p>To enhance the knowledge of students, this event is conducted where
the participants will be given a case study. They have to come up with
the appropriate solution for the same. And what they have learned
from the case, with the unique point which is related to case provided.<BR>
The objective of conducting this event is to see how students can
think in the different way towards a particular situation.
...
<ol>
This round will be an online eliminating round where in
the participants will be presented a case and they will have to submit
their analysis of the case with in the specified time dead line.

</ol><br>
<h4>ROUND 2</h4>
<ol>
This round will be a case presentation round in which the
participants will be required to come to the campus and present their
...
<h3>Rules</h3>
Teams must be composed of 2-3 members<br>
<li>The team members must be from same institute</li>
<li> A participant can be a part of only one team</li>
</div>
...
<div class="media-body">
<h3 style="color:#fff;margin-left:10px">VIBHAY NISCHAL</h3>

<h4 style="color:#fff;margin-left:10px">Ph no. 8676002567</h4>
</div>
</div>
...
$num = mysqli_num_rows(mysqli_query($con,"SELECT * FROM cas"));
echo $num;
 ?>
<small>in this event</small>
</div>
...
<li><a href="designer.php">DESIGN ER. </a></li>
          ...
          <ul style="list-style-type:none;">
			...
			<li><a href="mazolypic.php">MAZOLYPIC</a></li>
          </ul>
        </div>
           <div class="col col-xs-12 col-sm-12 col-md-3 col-lg-3">
          <h4>MANAGERIAL</h4>
          <ul style="list-style-type:none;">
           <li> <a href="quiz.php">QUIZZARD</a></li>
<li><a href="entrepre.php">ENTREPRENEURIAL SKILLS QUOTIENT</a></li>
<li><a href="casestdy.php">CASE STUDY</a></li>
<li><a href="wolf.php">WOLF OF WALLSTREET</a></li>
<li><a href="job.php">JOB FANTASYY</a></li>
          </ul>
        </div>
           <div class="col col-xs-12 col-sm-12 col-md-3 col-lg-3">
          <h4>ALCHEMIST</h4>
...
<li><a href="clash.php" >CLASH OF CLANS</a></li>
          </ul>
        </div>
           <!--<div class="col col-xs-12 col-sm-12 col-md-3 col-lg-3">
          <h4>QUIZZARD</h4>
