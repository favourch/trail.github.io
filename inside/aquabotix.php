...
<![endif]-->
<title>Aquabotix|Equilibrio 2k17</title>
...
<li class=""><a href="#tab4" data-toggle="tab" class="tehnical">Round 3</a></li>
<li class=""><a href="#tab5" data-toggle="tab" class="tehnical">Points Distribution</a></li>
<li class=""><a href="#tab6" data-toggle="tab" class="tehnical">General Rules</a></li>
...
It is an exciting branch of robotics. Robots can be wired, or they can be remotely operated which is capable to swim or run over the water surface. <br>

<h4>Bot Specification</h4>
<ol><li>Maximum dimension  of bot 35cm×30cmx30cm (length×width×height)</li>
<li>The motors to be used is within the range of 0-300 rpm. It will be checked in different conditions.</li>
<li>Bot can be wired or wireless.</li>
<li>Use of aurdino is allowed.</li>
</ol><br>
<h4>Power Supply</h4>
<ol><li> Supply of 220volt, 50hz ac will be provided.</li>
<li> Teams will have to bring down the voltage less than 19.5 volts.</li>
<li> The voltage at any point on the electrical connections should not exceed 19.5v.</li>
<li> Rechargable batteries are also allowed.</li>
<li> The wireless bot should be fully charged at the start of performance.</li>
</li></ol>
...
<h3>ROUND 1</h3>
<p>
<ol><li>There will be arena with well-designed path.</li><br>
<li>The teams are required to cross the pool from starting point to end point. Timer will stop only when bot will burst the balloon located at the end point.</li><br>
 <li>No of teams qualifying for the next round will be decided by organizer.</li><br></li><br>
<li>According to the points collected by each team, merit list will be made. No of teams qualifying for the next round will be decided on the basis of that merit list.</li><br>

Note:-the arena shown below is just a model.arena will be similar but not exactly the same .<br>
...
<p>
<h3>ROUND 2</h3>
<ol><li> In this round again in the same pool there will be a path and qualifying teams will have to reach to end point performing given task and burst the balloon at the end point.</li><br>
<li>The additional task in the second round is to grab the particles of different shapes floating inside the pool and put into the box provided inside pool.</li><br>
<li>Different shapes will have different points based on its difficulty level.</li><br>
<li>Merit list will be made on the basis of points collected by each team and qualifying teams will be upgraded to next round.
</li><br>
</ol>     
</p>
</div>
...
<p>
<h3>ROUND 3</h3>
<ol><li> There will be another arena in which two rotating fan are running over the surface of water to create whirl.
</li><br>
<li>There will be so many balls, balloons and balloons containing balls inside  the arena in one side of the pool.
</li><br>
<li>And bot will go there, blast the balloon, and pick  one or more balls and will put the balls into the bucket which is situated  inside  the pool.
...
<p><H3>POINTS DISTRIBUTION</H3>
<ol>
<li>Blast per balloon = 10 pts.</li>
<li> Dropping the particles into bucket:-<ul>
          <li>  balls       -           50pts   </li>     
          <li> cube/cuboid       -           30pts</li> 
          <li>  prism        -           40pts</li> 
           <li>  cone        -           50pts</li> </ul></li>
<li>Arena collision = -5 pts
<li>There will be time limitation (maximum time) in each round. The time will be told at the spot.
<li>Besides the above time the teams can use 5 min. In case of technical defect during game in each round.
<li> If any team mates touches the boat while performing task 10 points will be deducted for each time.
<li> If a team completes the task before the time limit then each saved second will add 1point in their account.
<li> Timer will stop when the boat burst the balloon at the end point.
</li><br>
...
<ol>
<li>A maximum of three members are allowed in each team.</li><br>
<li>Teams will have to submmit their boats before an hour of starting the event.</li><br>
<li>Ready made circuits are not allowed.</li><br>
...
<li>The particles can be dragged, pushed, or kicked by bot.</li><br>
...
<ol><li>If the boat crosses the specification limit.</li><br>
<li> Use of simple dc  and jhonson motor are allowed. Use of other motors than these two will bee a criterion for disqualification.</li><br>
...
<img src="assets/img/aquabotix.png" class="snakoarena">
</p>
</div>
...
<div class="pull-left">
<img class="img-responsive img-circle" src="assets/img/team/head/aqua.jpg">
</div>
<div class="media-body">
<h3 style="color:#fff;margin-left:10px">Abhishek Teniwal</h3>
<h4 style="color:#fff;margin-left:10px">Ph no. 8955619927</h4>
</div>
</div>
...
$num = mysqli_num_rows(mysqli_query($con,"SELECT * FROM aquabotix"));
echo $num;
 ?>
<small>in this event</small>
</div>
