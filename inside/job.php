...
<![endif]-->
<title>JobBattle|Equilibrio 2k17</title>
...
<p>Without ambition one starts nothing. Without work one finishes nothing. The prize will not be sent to you. You have to win it. </p><br>
<p>It is a only event which not only give you a rough idea for your upcoming job selections procedure but also prepare you for your dream because any big exam have these three barriers on their way.</p><br>
<h4>The complete event consists of three rounds.

</h4><br><h4>It is a single participant event.</h4>
...
<h3>ROUND 1</h3>
<p>
<ol><li>This will be of 1 hour (several time slots available).</li><br>
<li>This will be an aptitude test based on real aptitude. </li><br>
<li>This will be an elimination round. </li><br>
<li>The participants who will qualify round 1 will move to the next round.</li><br>
</ol>
...
<p>
<h3>ROUND 2</h3>
<ol><li>This round will be of 15 minutes. </li><br>
<li>This round will consist of a group discussion.</li><br>
<li>This is again an elimination round</li><br>
<li>Students will be given a topic. From each group we will select some participants and they will move to the next round.</li><br>
</ol> 
<h5>Rules and regulation for GD round will be illustrated at that instance only.</h5>    
</p>
</div>
<div class="tab-pane fade" id="tab4">
<p><H3>ROUND 3</H3>
<ol><li>This is a 
personal interview round.</li><br>
<li>This is the final round. </li><br>

</ol>
<h5>After this round winner will be announced.</h5>
</p>
</div>
...
<div class="pull-left">
<img class="img-responsive img-circle" src="assets/img/team/head/job.jpg">
</div>
<div class="media-body"><br>
<h3 style="color:#fff;margin-left:10px">Maheep Singh</h3>

<h4 style="color:#fff;margin-left:10px">Ph no. 7354451252</h4>
</div>
</div>
...
$num = mysqli_num_rows(mysqli_query($con,"SELECT * FROM job"));
echo $num;
 ?>
<small>in this event</small>
</div>
