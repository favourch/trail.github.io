...
<![endif]-->
<title>CAMPUS AMBASSADOR | Equilibrio 2k18</title>
...
<link rel="stylesheet" href="css/camain.css">
...
<br>
1.  Conduct a promotional workshop in your college premises.
     <br><br>                            
2.  Organize a flash mob inside or outside your college.
         <br><br>                        
3.  Conduct a promotional event.
           <br><br>                      
4.  5 successful registrations.
<br><br>
5.  +50 likes on EQUILIBRIO official page. Follow on other social links.<br><br>
6.  Share each post from EQUILIBRIO official page. <br><br>
...
<script type="text/javascript"> JotForm.init(function(){ JotForm.setCustomHint( 'input_13', 'For postal contact' ); JotForm.clearFieldOnHide="disable"; JotForm.onSubmissionError="jumpToFirstError"; });
</script>
<link href="https://cdn.jotfor.ms/static/formCss.css?3.3.16208" rel="stylesheet" type="text/css" />
<link type="text/css" rel="stylesheet" href="https://cdn.jotfor.ms/css/styles/nova.css?3.3.16208" />
<link type="text/css" media="print" rel="stylesheet" href="https://cdn.jotfor.ms/css/printForm.css?3.3.16208" />
<link type="text/css" rel="stylesheet" href="https://cdn.jotfor.ms/themes/CSS/566a91c2977cdfcd478b4567.css?"/>
<style type="text/css"> .form-label-left{ width:150px !important; } .form-line{ padding-top:12px; padding-bottom:12px; } .form-label-right{ width:150px !important; } .form-all{ width:100%; color:#555 !important; font-family:"Lucida Grande", "Lucida Sans Unicode", "Lucida Sans", Verdana, sans-serif; font-size:14px; } .form-radio-item label, .form-checkbox-item label, .form-grading-label, .form-header{ color: #555; } </style> <link type="text/css" rel="stylesheet" href="https://cdn.jotfor.ms/css/styles/buttons/form-submit-button-book_blue2.css?3.3.16208"/>
<form class="jotform-form" action="https://submit.jotform.me/submit/63553901991462/" method="post" name="form_63553901991462" id="63553901991462" accept-charset="utf-8"> <input type="hidden" name="formID" value="63553901991462" /> <div class="form-all"> <ul class="form-section page-section"> <li id="cid_1" class="form-input-wide" data-type="control_head"> <div class="form-header-group"> <div class="header-text httal htvam"> <h2 id="header_1" class="form-header"> Campus Ambassador Form </h2> </div> </div> </li> <li class="form-line jf-required" data-type="control_fullname" id="id_3"> <label class="form-label form-label-left form-label-auto" id="label_3" for="input_3"> Name <span class="form-required"> * </span> </label> <div id="cid_3" class="form-input jf-required"> <span class="form-sub-label-container" style="vertical-align: top;"> <input class="form-textbox validate[required]" type="text" size="10" name="q3_name[first]" id="first_3" /> <label class="form-sub-label" for="first_3" id="sublabel_first" style="min-height: 13px;"> First Name </label> </span> <span class="form-sub-label-container" style="vertical-align: top;"> <input class="form-textbox validate[required]" type="text" size="15" name="q3_name[last]" id="last_3" /> <label class="form-sub-label" for="last_3" id="sublabel_last" style="min-height: 13px;"> Last Name </label> </span> </div> </li> <li class="form-line jf-required" data-type="control_email" id="id_4"> <label class="form-label form-label-left form-label-auto" id="label_4" for="input_4"> E-mail <span class="form-required"> * </span> </label> <div id="cid_4" class="form-input jf-required"> <input type="email" class=" form-textbox validate[required, Email]" id="input_4" name="q4_email" size="30" value="" /> </div> </li> <li class="form-line form-line-column form-col-1 jf-required" data-type="control_textbox" id="id_5"> <label class="form-label form-label-top" id="label_5" for="input_5"> Ph. Number <span class="form-required"> * </span> </label> <div id="cid_5" class="form-input-wide jf-required"> <input type="text" class=" form-textbox validate[required]" data-type="input-textbox" id="input_5" name="q5_phNumber" size="20" value="" maxlength="10" /> </div> </li> <li class="form-line form-line-column form-col-2 jf-required" data-type="control_textbox" id="id_6"> <label class="form-label form-label-top" id="label_6" for="input_6"> Whatsapp Number <span class="form-required"> * </span> </label> <div id="cid_6" class="form-input-wide jf-required"> <input type="text" class=" form-textbox validate[required]" data-type="input-textbox" id="input_6" name="q6_whatsappNumber" size="20" value="" maxlength="10" /> </div> </li> <li class="form-line jf-required" data-type="control_textbox" id="id_7"> <label class="form-label form-label-left form-label-auto" id="label_7" for="input_7"> FB Profile Link <span class="form-required"> * </span> </label> <div id="cid_7" class="form-input jf-required"> <input type="text" class=" form-textbox validate[required]" data-type="input-textbox" id="input_7" name="q7_fbProfile" size="20" value="" /> </div> </li> <li class="form-line jf-required" data-type="control_textbox" id="id_8"> <label class="form-label form-label-left form-label-auto" id="label_8" for="input_8"> College Name <span class="form-required"> * </span> </label> <div id="cid_8" class="form-input jf-required"> <input type="text" class=" form-textbox validate[required]" data-type="input-textbox" id="input_8" name="q8_collegeName" size="20" value="" /> </div> </li> <li class="form-line form-line-column form-col-1" data-type="control_textbox" id="id_9"> <label class="form-label form-label-top" id="label_9" for="input_9"> Referrence </label> <div id="cid_9" class="form-input-wide jf-required"> <input type="text" class=" form-textbox" data-type="input-textbox" id="input_9" name="q9_referrence" size="20" value="" /> </div> </li> <li class="form-line form-line-column form-col-2 jf-required" data-type="control_checkbox" id="id_10"> <label class="form-label form-label-top" id="label_10" for="input_10"> Year of Study <span class="form-required"> * </span> </label> <div id="cid_10" class="form-input-wide jf-required"> <div class="form-single-column"> <span class="form-checkbox-item" style="clear:left;"> <span class="dragger-item"> </span> <input type="checkbox" class="form-checkbox validate[required]" id="input_10_0" name="q10_yearOf[]" value="1st year" /> <label id="label_input_10_0" for="input_10_0"> 1st year </label> </span> <span class="form-checkbox-item" style="clear:left;"> <span class="dragger-item"> </span> <input type="checkbox" class="form-checkbox validate[required]" id="input_10_1" name="q10_yearOf[]" value="2nd year" /> <label id="label_input_10_1" for="input_10_1"> 2nd year </label> </span> <span class="form-checkbox-item" style="clear:left;"> <span class="dragger-item"> </span> <input type="checkbox" class="form-checkbox validate[required]" id="input_10_2" name="q10_yearOf[]" value="3rd year" /> <label id="label_input_10_2" for="input_10_2"> 3rd year </label> </span> <span class="form-checkbox-item" style="clear:left;"> <span class="dragger-item"> </span> <input type="checkbox" class="form-checkbox validate[required]" id="input_10_3" name="q10_yearOf[]" value="4th year" /> <label id="label_input_10_3" for="input_10_3"> 4th year </label> </span> </div> </div> </li> <li class="form-line jf-required" data-type="control_textarea" id="id_13"> <label class="form-label form-label-left form-label-auto" id="label_13" for="input_13"> Current Address <span class="form-required"> * </span> </label> <div id="cid_13" class="form-input jf-required"> <textarea id="input_13" class="form-textarea validate[required]" name="q13_currentAddress" cols="40" rows="6" data-component="textarea"></textarea> </div> </li> <li class="form-line jf-required" data-type="control_textarea" id="id_12"> <label class="form-label form-label-left form-label-auto" id="label_12" for="input_12"> Why you should be selected <span class="form-required"> * </span> </label> <div id="cid_12" class="form-input jf-required"> <textarea id="input_12" class="form-textarea validate[required]" name="q12_whyYou" cols="40" rows="6" data-component="textarea"></textarea> </div> </li> <li class="form-line" data-type="control_button" id="id_2"> <div id="cid_2" class="form-input-wide"> <div style="margin-left:156px;" class="form-buttons-wrapper"> <button id="input_2" type="submit" class="form-submit-button form-submit-button-book_blue2" data-component="button"> Submit </button> </div> </div> </li> <li style="clear:both"> </li> <li style="display:none"> Should be Empty: <input type="text" name="website" value="" /> </li> </ul> </div> <script> JotForm.showJotFormPowered = true; </script> <input type="hidden" id="simple_spc" name="simple_spc" value="63553901991462" /> <script type="text/javascript"> document.getElementById("si" + "mple" + "_spc").value = "63553901991462-63553901991462"; </script>
</form>
<script type="text/javascript">JotForm.ownerView=true;</script>-->
<script src="https://cdn.jotfor.ms/js/vendor/jquery-1.8.0.min.js?v=3.3.3305" type="text/javascript"></script>
<script src="https://cdn.jotfor.ms/js/vendor/maskedinput.min.js?v=3.3.3305" type="text/javascript"></script>
<script src="https://cdn.jotfor.ms/js/vendor/jquery.maskedinput.min.js?v=3.3.3305" type="text/javascript"></script>
<script src="https://cdn.jotfor.ms/static/prototype.forms.js" type="text/javascript"></script>
<script src="https://cdn.jotfor.ms/static/jotform.forms.js?3.3.3305" type="text/javascript"></script>
<script type="text/javascript">
   ...
   JotForm.prepareCalculationsOnTheFly([null,{"name":"campusAmbassador","qid":"1","text":"Campus Ambassador Form","type":"control_head"},{"name":"submit2","qid":"2","text":"Submit","type":"control_button"},{"name":"name3","qid":"3","text":"Name ","type":"control_fullname"},{"name":"email","qid":"4","text":"Email","type":"control_email"},{"name":"phoneNumber","qid":"5","text":"Phone Number","type":"control_phone"},null,{"name":"fbProfile","qid":"7","text":"FB Profile Link ","type":"control_textbox"},{"name":"collegeName","qid":"8","text":"College Name","type":"control_textbox"},{"name":"referrence","qid":"9","text":"Referrence","type":"control_textbox"},{"name":"yearOf","qid":"10","text":"Year of Study ","type":"control_checkbox"},{"name":"currentAddress","qid":"11","text":"Current Address ","type":"control_textarea"},{"name":"whyYou","qid":"12","text":"Why you should be selected ","type":"control_textarea"},{"name":"whatsappNumber13","qid":"13","text":"Whatsapp Number","type":"control_textbox"}]);
   setTimeout(function() {
JotForm.paymentExtrasOnTheFly([null,{"name":"campusAmbassador","qid":"1","text":"Campus Ambassador Form","type":"control_head"},{"name":"submit2","qid":"2","text":"Submit","type":"control_button"},{"name":"name3","qid":"3","text":"Name ","type":"control_fullname"},{"name":"email","qid":"4","text":"Email","type":"control_email"},{"name":"phoneNumber","qid":"5","text":"Phone Number","type":"control_phone"},null,{"name":"fbProfile","qid":"7","text":"FB Profile Link ","type":"control_textbox"},{"name":"collegeName","qid":"8","text":"College Name","type":"control_textbox"},{"name":"referrence","qid":"9","text":"Referrence","type":"control_textbox"},{"name":"yearOf","qid":"10","text":"Year of Study ","type":"control_checkbox"},{"name":"currentAddress","qid":"11","text":"Current Address ","type":"control_textarea"},{"name":"whyYou","qid":"12","text":"Why you should be selected ","type":"control_textarea"},{"name":"whatsappNumber13","qid":"13","text":"Whatsapp Number","type":"control_textbox"}]);}, 20); 
</script>
<link href="https://cdn.jotfor.ms/static/formCss.css?3.3.3305" rel="stylesheet" type="text/css" />
<link type="text/css" rel="stylesheet" href="https://cdn.jotfor.ms/css/styles/nova.css?3.3.3305" />
<link type="text/css" media="print" rel="stylesheet" href="https://cdn.jotfor.ms/css/printForm.css?3.3.3305" />
<link type="text/css" rel="stylesheet" href="https://cdn.jotfor.ms/themes/CSS/566a91c2977cdfcd478b4567.css?"/>
<style type="text/css">
    .form-label-left{
        width:150px;
...
<link type="text/css" rel="stylesheet" href="https://cdn.jotfor.ms/css/styles/buttons/form-submit-button-black_glass.css?3.3.3305"/>
<form class="jotform-form" action="https://submit.jotform.me/submit/73438271803457/" method="post" name="form_73438271803457" id="73438271803457" accept-charset="utf-8">
  <input type="hidden" name="formID" value="73438271803457" />
  <div class="form-all">
    <ul class="form-section page-section">
        ...
        <div id="cid_3" class="form-input jf-required">
          <div data-wrapper-react="true">
            <span class="form-sub-label-container" style="vertical-align:top;">
              <input type="text" id="first_3" name="q3_name3[first]" class="form-textbox validate[required]" size="10" value="" placeholder="sLes" data-component="first" required="" />
              <label class="form-sub-label" for="first_3" id="sublabel_first" style="min-height:13px;"> First Name </label>
            </span>
            <span class="form-sub-label-container" style="vertical-align:top;">
              <input type="text" id="last_3" name="q3_name3[last]" class="form-textbox validate[required]" size="15" value="" data-component="last" required="" />
      ...
      <li class="form-line jf-required" data-type="control_phone" id="id_5">
        <label class="form-label form-label-right" id="label_5" for="input_5_full">
          Phone Number
          <span class="form-required">
            *
          </span>
        ...
        <div id="cid_5" class="form-input jf-required">
          <span class="form-sub-label-container" style="vertical-align:top;">
            <input type="tel" id="input_5_full" name="q5_phoneNumber[full]" data-type="mask-number" class="mask-phone-number form-textbox validate[required]" autocomplete="off" data-masked="true" value="" data-component="phone" required="" />
            <label class="form-sub-label" for="input_5_masked" id="sublabel_masked" style="min-height:13px;"> 9630****** </label>
          </span>
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_textbox" id="id_13">
        ...
        <div id="cid_13" class="form-input jf-required">
          <input type="text" id="input_13" name="q13_whatsappNumber13" data-type="input-textbox" class="form-textbox validate[required, Numeric]" size="10" value="" data-component="textbox" required="" />
        </div>
      </li>
      <li class="form-line" data-type="control_textbox" id="id_9">
        <label class="form-label form-label-right form-label-auto" id="label_9" for="input_9"> Referrence </label>
        <div id="cid_9" class="form-input">
          <input type="text" id="input_9" name="q9_referrence" data-type="input-textbox" class="form-textbox" size="20" value="" data-component="textbox" />
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_textbox" id="id_7">
        ...
        <div id="cid_7" class="form-input jf-required">
          <input type="text" id="input_7" name="q7_fbProfile" data-type="input-textbox" class="form-textbox validate[required]" size="20" value="" data-component="textbox" required="" />
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_textbox" id="id_8">
        ...
        <div id="cid_8" class="form-input jf-required">
          <input type="text" id="input_8" name="q8_collegeName" data-type="input-textbox" class="form-textbox validate[required]" size="20" value="" data-component="textbox" required="" />
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_checkbox" id="id_10">
        <label class="form-label form-label-left" id="label_10" for="input_10_0">
          Year of Study 
          <span class="form-required">
            *
          </span>
        ...
        <div id="cid_10" class="form-input jf-required">
          <div class="form-single-column" data-component="checkbox">
            <span class="form-checkbox-item" style="clear:left;">
              ...
              <input type="checkbox" class="form-checkbox validate[required]" id="input_10_0" name="q10_yearOf[]" value="1st year" required="" />
              <label id="label_input_10_0" for="input_10_0"> 1st year </label>
            </span>
            <span class="form-checkbox-item" style="clear:left;">
              <span class="dragger-item">
              </span>
              <input type="checkbox" class="form-checkbox validate[required]" id="input_10_1" name="q10_yearOf[]" value="2nd year" required="" />
              <label id="label_input_10_1" for="input_10_1"> 2nd year </label>
            </span>
            <span class="form-checkbox-item" style="clear:left;">
              <span class="dragger-item">
              </span>
              <input type="checkbox" class="form-checkbox validate[required]" id="input_10_2" name="q10_yearOf[]" value="3rd year" required="" />
              <label id="label_input_10_2" for="input_10_2"> 3rd year </label>
            </span>
            <span class="form-checkbox-item" style="clear:left;">
              <span class="dragger-item">
              </span>
              <input type="checkbox" class="form-checkbox validate[required]" id="input_10_3" name="q10_yearOf[]" value="4th year" required="" />
              <label id="label_input_10_3" for="input_10_3"> 4th year </label>
            </span>
          </div>
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_textarea" id="id_11">
        ...
        <div id="cid_11" class="form-input jf-required">
          <textarea id="input_11" class="form-textarea validate[required]" name="q11_currentAddress" cols="40" rows="6" data-component="textarea" required=""></textarea>
        </div>
      </li>
      <li class="form-line jf-required" data-type="control_textarea" id="id_12">
        ...
        <div id="cid_12" class="form-input jf-required">
          <textarea id="input_12" class="form-textarea validate[required]" name="q12_whyYou" cols="40" rows="6" data-component="textarea" required=""></textarea>
        </div>
      </li>
  ...
  <input type="hidden" id="simple_spc" name="simple_spc" value="73438271803457" />
  <script type="text/javascript">
  document.getElementById("si" + "mple" + "_spc").value = "73438271803457-73438271803457";
  </script>
  <div class="formFooter-heightMask">
  </div>
  <!--<div class="formFooter">
    <a href="https://www.jotform.com/?utm_source=formfooter&utm_medium=banner&utm_term=73438271803457&utm_content=jotform_logo&utm_campaign=powered_by_jotform_signup_hp" target="_blank" class="formFooter-logoLink"><img class="formFooter-logo" src="https://cdn.jotfor.ms/assets/img/logo/logo-new@1x.png" alt="" style="height: 44px;"></a>
    <div class="formFooter-rightSide">
      <span class="formFooter-text">
        Now create your own JotForm - It's free!
      </span>
      <a class="formFooter-button" href="https://www.jotform.com/?utm_source=formfooter&utm_medium=banner&utm_term=73438271803457&utm_content=jotform_button&utm_campaign=powered_by_jotform_signup_hp" target="_blank">Create your own JotForm</a>
    </div>
  </div>-->
</form>
<script type="text/javascript">JotForm.ownerView=true;</script>
...
<li><a href="clash.php" >MINI MILITIA</a></li>
          ...
          <ul style="list-style-type:none;">
            ...
            <li><a href="general.php">GENERAL QUIZ</a></li>
