...
<![endif]-->
<title>NFS|Equilibrio 2k17</title>
...
background:url(parallax/css/images/nfs1.png) no-repeat;}
.planet2{
background:url(parallax/css/images/nfs2.png) no-repeat;}
    </style>
...
<li><a href="#tab2" data-toggle="tab" class="analistic-02">Game Play</a></li>
<li class=""><a href="#tab3" data-toggle="tab" class="tehnical">Rules</a></li>
<li class=""><a href="#tab4" data-toggle="tab" class="tehnical">Team Members</a></li>
...
<p>You all are locked in a hungry demon’s room. To save yourself you need the key of the lock, but unfortunately there is only one key for every two locks. So you have to compete with each other and all you wish is...NEED FOR SPEED.</p><br>
<h4>Bot Specification</h4>
<ol><li>The autonomous bot to be prepared must fit in a box of dimensions 25cm*20cm*20cm(l*b*h).</li><br>
<li>The bot could be provided power supply either externally or can have an on board supply as per convenience of the participants.</li><br>
...
<p>
<ol><li>
In arena there will be two symmetrical paths each having a start point and a end point.</li>
<li>The game would comprise of many rounds.</li><br>
<li>In each round the bot has to compete with the other bot to reach the end point traversing the path from start to end point.</li>
<li>The one who reach the end point first, will be qualified for next round.</li><br>
<li>The winner will be decided in final round played by the two finalist</li> <br>
...
<p>
<h3>RULES</h3>
<ol><li>The timing of the team would be started once the instructor gives the signal to start the bot.</li><br>
...
<li>A total of 3 restarts would be provided to each team.</li><br>
...
<li>The team has to be present at the event place within 5 minutes of the final call otherwise they will be disqualified.</li><br>
<li>The arena will be disclosed 10 minutes before the event starts.</li></ol>     
</p>
</div>
<div class="tab-pane fade" id="tab4">
<p><H3>TEAM MEMBERS</H3>
<ol><li>A team would comprise a maximum of 4 members.</li><br>
<li>The team members should submit their name before commencement of the competition ALONGWITH A TEAM NAME.</li><br>
</ol>
</p>
</div>
...
<div class="media-body">
<h3 style="color:#fff;margin-left:10px">Anshu Kumari</h3>
<h4 style="color:#fff;margin-left:10px">Ph no. 9473300236</h4>
</div>
</div>
...
$num = mysqli_num_rows(mysqli_query($con,"SELECT * FROM nfs"));
echo $num;
 ?>
<small>in this event</small>
</div>
