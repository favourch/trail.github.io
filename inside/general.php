...
<![endif]-->
<title>GeneralQuiz|Equilibrio 2k18</title>
...
<p>
If you think you know the world around you better, general quiz welcomes you to test yourself. The mother of all quizzes, general quiz contains questions from every topic under one roof.</p><br>
Cracking this won’t be easy as it looks because this quiz tests your ability to memorise important facts and events relating to an ocean of topics at every step.
So get ready, kickstart yourself and win.

<br><br>
<h4>Team size : 2 members </h4> 
...
$num = mysqli_num_rows(mysqli_query($con,"SELECT * FROM general"));
echo $num;
 ?>
<small>in this event</small>
</div>
