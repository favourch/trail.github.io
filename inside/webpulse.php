...
<![endif]-->
<title>WebPulse|Equilibrio 2k17</title>
...
background:url(parallax/css/images/webpulse1.png) no-repeat;}
.planet2{
background:url(parallax/css/images/webpulse2.png) no-repeat;}
    </style>
...
<h4>It was amazing, the cyber world, the amalgam of knowledge and creativity, now I am diving deeper!!!” </h4><br>
<h4>Event Format: </h4>
<ul><li>The event consists of two rounds..</li><br>
<ol><li>Written Test</li><li>Replica Round</li></ol>
</ul><br>
<h4>TEAM SIZE:</h4>
<ul><li>Individual participation.</li><br>
...
<h4>ROUND 1</h4>
<ul><li>The first round covers both subjective and objective
questions covering Web Technologies (HTML, CSS, JS ,Bootstrap).
</li><br>

</ul>
<h4>ROUND 2</h4>
<ul><li>Top 5 candidates from Round 1 will be selected for Second round.
</li><br>
<li>In Replica Round, candidates have to replicate or clone a website shown to them at the start of this round.</li><br>
<li>Website will be shown only for 5 minutes. After which candidate have to start creating their own.</li><br>
<li>Candidates must use Bootstrap and site should be Responsive.</li><br>
<li>Adding functionality and use of Backend will be  given preferrence.</li>
</ul>
...
<ul>
  <li>Written Test
  <ol><li>Candidates are not allowed to use mobile,tablets and other electronic gadgets.</li><br>
  <li>Any means of cheating will not be tolerated.It may lead to disqualification.</li><br>
  <li>Test will start and end as decided by Event Coordinator. No extra time and preferrence will be given.</li><br>
  </ol></li><br>
  <li>Replica Round
  <ol><li>Website will be shown only for 5 minutes.</li><br>
  <li>No Pen Paper should be used to memorise the layout and other functionality.</li><br>
  <li>Bootstrap library files will be provided in event.</li><br>
...
<p>Candidates will be ranked according to Marking Scheme of the paper. Top 5 will be selected for next round.</p>
</p><br><br>
<h4>REPLICA ROUND</h4><br>
<p>Candidates will be judged on design similarity, functional similarity and responsiveness of their site.</p>
</div>
...
<div class="media-body">
<h3 style="color:#fff;margin-left:10px">Shubham Pandey</h3>

<h4 style="color:#fff;margin-left:10px">Ph no. 7838283212</h4>
</div>
</div>
...
$num = mysqli_num_rows(mysqli_query($con,"SELECT * FROM webpulse"));
echo $num;
 ?>
<small>in this event</small>
</div>
