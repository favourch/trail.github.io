...
<![endif]-->
<title>TaalSangram|Equilibrio 2k18</title>
...
background:url(parallax/css/images/band1.png) no-repeat;}
.planet2{
background:url(parallax/css/images/band2.png) no-repeat;}
    </style>
...
<li class=""><a href="#tab3" data-toggle="tab" class="tehnical">Judgement Criteria</a></li>

<li class=""><a href="#tab4" data-toggle="tab" class="tehnical">Prize</a></li>
</ul>
</div>
...
<p>Take time to deliberate, but when the time for action has arrived, stop thinking and go in.
Taal Sangram is a live contest in which selected Bands will compete for the title of "Best band". All genres of rock, metal, jazz, bollywood, folk and many different styles are invited. The winning band will receive a prize and a gift certificate. So prepare yourself for the gig.</p><br>
<h4>Format Of the Event</h4>
<ol><li>Screening <ul><li>Bands must consist of at least three members, one of which plays an instrument throughout the majority of the performance.</li>
<li>All performers must be between 10 to 25 years of age. Band must be unsigned. </li>
<li> The entire performance must be live – no pre-recorded music is allowed. </li>
<li>Bands must submit the registration form.</li>
</ul></li><br>
<h5>Video/audio clip:- with each song in a separate ﬁle. Registration forms and demo video can be emailed:</h5>
<li>Finale<ul><li>In this round, finalists (5) bands must play 3 or 4 songs no longer than 5 minutes each. 

</li>
<li>All groups/bands will be allotted a 15-20mins show and not to exceed 20 minutes or else 1 point will be deducted from the overall score every second over the time specified.</li></ul></li><br>
...
<p>
<ol><li>
All bands agree to have their name, voice, and/or likenesses used in any advertising or broadcasting material relating to this contest without any compensation or rights to royalties for such use.</li>
<li>Band members must provide all musical instruments and equipment necessary for their performance, the sound system will be supplied. </li>
<li>Band members are responsible for the security of their equipment and the event organizers cannot be held liable for any lost, damaged, or stolen equipment. 4. Fires, pyrotechnics, fog machines, etc. are not allowed</li>
<li>Group/Bands members must appear 30 min prior to performance to check in, failure to comply will result in disqualification. </li>
<li>On the day of the performance, band members must be dressed in clothing free from obscenities, drugs, alcohol, sex, or any other subject matter not suitable for a family audience.
</li>
<li>The entire performance must be violence-free and suitable for families.</li>
<li>Bands must report to the staging at their designated set-up time and remain on-site until the end of their performance.
</li>
<li>Finally, all bands must be present for the announcement of the winners. Any bands not present at the required times may be disqualified.
</li>
</ol>
...
A panel of judges will score musicians using a point system. Criteria to be considered include: Stage Presentation, Sound Volume & Clarity, Band Synchronization, Time Management, Song Quality & Originality, Stage Management, Band Enthusiasm & Attitude, and Audience Response. Judges will award points in each category using a point system. If bands end up in a tie, the following individual category scores will decide the winner (in order): Stage Presentation, Song Quality & Originality, and Audience Response.
<h5>Judging is done on a 1-50 scale by 3 judges. 
</h5>
The 3 criteria on which the bands will be judged is: 
<ol><li>MUSIC :- clarity of sound, pitch-tone-beat-rhythm, originality, overall performance.</li><br>
<li>PRESENTATION: - preparedness, audience connection, quality of performance</li><br>
<li>APPERANCE: - Overall look of band creativity.</li><br>
</ol>     
All competing bands are strongly encouraged to promote spreading the word regarding the Taal sangram event and the equilibrio and related festivities as crowd interaction and response will be part of the judging criteria.</p>
</div>
...
$num = mysqli_num_rows(mysqli_query($con,"SELECT * FROM band"));
echo $num;
 ?>
<small>in this event</small>
</div>
