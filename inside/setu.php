...
<![endif]-->
<title>Setu Sanrachna|Equilibrio 2k17</title>
...
background:url(parallax/css/images/setu1.png) no-repeat;}
.planet2{
background:url(parallax/css/images/setu2.png) no-repeat;}
    </style>
...
<li class="active"><a href="#tab2" data-toggle="tab" class="analistic-02">Guidelines</a></li>
<li class=""><a href="#tab3" data-toggle="tab" class="tehnical">Specifications</a></li>

<li class=""><a href="#tab4" data-toggle="tab" class="tehnical">Judging Criteria</a></li>
...
<p>
<ol><li>
 Minimum clear span of 40cm. Maximum bridge length of 50cm. </li>
 <li>Laminated members are not allowed(except joints).</li>
<li>The bridge weight should be in accordance with judgement creiteria. </li><br>
<li>Members may not be wider than 3cm and deeper (max thickness) than 2cm except cross girders max 4cm.</li>
<li>The bridge deck must extend the entire length of the bridge and maintain a "vehicular roadway" without any obstruction (12cm wide x 15cm high). The bridge deck shall be level (or flat) and shall not be curved (or arched).<br> The bridge deck shall be constructed using a single, solid, thermocol sheet. The bridge deck should be the full width of the vehicular roadway and extend the entire length of the bridge's longest dimension.
</li><br>
<li>To allow for testing, there must be a hole at mid-span in the bridge deck fitted with hook bolt(provided). There must be no obstructions below the hole that would prevent the passage of the testing rod</li> <br>
<li>The model bridges will be loaded initially with only the bucket and testing apparatus.</li><br>
...
<p>
<h4>SPECIFICATION</h4>
<ol><li>The materials used in the construction of the bridge shall consist only of provided materials(1 thermocol sheet,cutter,Tape,pins). </li><br>
<li>The members must not be laminated with tape throughout the length. </li><br>
<li>The bridge shall contain no member wider than 3cm and deeper than 2cm(max thickness). This member size requirement does not apply for the cross girders, they can be no wider than 4cm and thicker than 2cm. Individual members shall be constructed of a single piece of thermacol sheet. elaminated members are not allowed. 
</li><br>
<li>The bridge shall be a minimum of 12cm wide and must allow a 12cmx 15cmx15cm cuboid to be passed along the length of the bridge ("vehicular roadway" with no obstructions, referenced above). The maximum length of the bridge shall be 50cm</li><br>
<li>The bridge must have a minimum clear span of 40cm between supports.The bridge shall be freestanding. </li><br>
<li>The bridge deck shall be the full width of the vehicular roadway and extend the entire length of the bridge's longest dimension. There must be a hole fitted with hook bolt(provided) at mid-span in the bridge deck to allow for testing. There must be no obstructions below the hole that would prevent the passage of the testing rod.
</li><br>
</ol>     
</p>
</div>
...
<p><H4>JUDGING CRITERIA</H4>
<ol><li>Maximum [(LOAD/WEIGHT)x10]. 
</li><br>
<li>DEFLECTION=should satisfy servicibility criteria,After 5mm deflection for every 2mm negative marks will be rewarded.
</li><br>
<li>MINIMUM TAPE USED .</li><br>
<li>.Minimum Number of Pins.
</li><br>
<li>TIME=Reference time 2hours,participants completing task before 2hrs will be rewarded with bonus marks per 5minutes. </li><br>
...
<div class="media-body">
<h3 style="color:#fff;margin-left:10px">Abhishek Singh</h3>

<h4 style="color:#fff;margin-left:10px">Ph no. 9479060466</h4>
...
$num = mysqli_num_rows(mysqli_query($con,"SELECT * FROM setu"));
echo $num;
 ?>
<small>in this event</small>
</div>
