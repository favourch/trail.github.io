...
<![endif]-->
<title>Paper Presentation|Equilibrio 2k17</title>
...
<p><h4>IDEALISE CONCEPTUALISE REVOLUTIONALIZE</h4>
We encourage the efforts of those who would like to ‘ideate’ for a better future. Hone your technical and presentation skills at our Launchpad. 
</p>
<br>
<h4>This is team based event.</h4><br>
<h4>Maximum number of member is 3.</h4>
</div>
</div>
</div>
...
<h4>ROUND 1</h4>
<ol>
  <li>This round consists of abstract submission.</li><br>
  <li>One can select any topic of their choice and have to mail their 
   Research abstract.
</li><br>
  <li>The abstract should be in following format.
  <ul>
  <li>title of idea</li>
  <li>definition</li>
  <li>solution</li>
  ...
  <li>Required file type MS word or PDF</li><br>
  <li>Preferred font would be TimesNewRoman with a text size   
    of 12 point size and headings of 14 point size
</li><br>
  <li>Last date for submission will be <strong>15th JAN till 5pm.</strong></li><br>
  <li>Abstract must be sent to <strong>paperpptequifest@gmail.com</strong> before the deadline.</li>
</ol>
</div>
</div>
</div>
...
<ol><li>Top 10 teams selected for final round will be announced by  
    16 th JAN till 5pm. 
</li><br>
<li>Each of the selected team has to come with a presentation   
    on the day of final round with one soft and hard 
    copy.
</li><br>
<li>Each team will have a 15 min time slot in which presentation 
     should be limited to 10 min or lesser followed by which 
     there will be a questionnaire round by judge panel.
</li><br>
<li>On the basis of imagination, originality and freshness of your 
     Ideas top 2 teams will be decided winner & runner.
.</li><br>
<li>In case of any dispute, judges decision will be final and 
    binding.
</li>
</ol>
</p>
...
<div class="media-body">
<h3 style="color:#fff;margin-left:10px">Rahul Kumar</h3>
<h4 style="color:#fff;margin-left:10px">Ph no. 7024082038</h4>
</div>
<div class="pull-left">
<img class="img-responsive img-circle" src="eventhead.png">
</div>
<div class="media-body">
<h3 style="color:#fff;margin-left:10px">Deepshikha Katiyar</h3>
<h4 style="color:#fff;margin-left:10px">Ph no. 9455709364</h4>
</div>
</div>
...
$num = mysqli_num_rows(mysqli_query($con,"SELECT * FROM paperp"));
echo $num;
 ?>
<small>in this event</small>
</div>
