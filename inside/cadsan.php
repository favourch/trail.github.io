...
<![endif]-->
<title>Cad Sangram|Equilibrio 2k18</title>
...
<li class="active"><a href="#tab1" data-toggle="tab" class="analistic-02">DESCRIPTION</a></li>
<li class=""><a href="#tab2" data-toggle="tab" class="tehnical">RULES</a></li>
<li class=""><a href="#tab3" data-toggle="tab" class="tehnical">JUDGEMENT</a></li><!--
<li class=""><a href="#tab4" data-toggle="tab" class="tehnical">REQUIREMENTS</a></li>-->
...
<p>
<p style="color:green"><b>"your imagination is WEAPON of mass construction, use it". </b></p>
If plans and elevations are the building blocks of your ecosystem and the thought of buildings and constructions makes your eyes light up, EQUILIBRIO'18 brings you the test of your world through CAD-SANGRAM.      Be part of an indented extravaganza and prove your wits. </p>
<br><br><h4>ABOUT</h4> <p>PARTICIPANTS  ARE REQUIRED TO  DRAFT  THE  PROVIDED PROBLEMS IN THE  STIPULATED  TIME .  JUDGEMENT  WILL  BE  BASED  ON  THEIR  PRECISENESS IN  UNDERSTANDING  AND  DRAFTING  THE  ALLOTED  PROBLEMS.
THUS , “ CAD – SANGRAM”  IS  AN  EVENT  WHICH  WILL  TEST  THE  ENGG. DRAWING  LOGICS  AND  DRAFTING  SKILLS  OF  THE  PARTICIPANTS.
...
<p><H4>RULES</h4><li>
THE  EVENT  WILL  BE  CONDUCTED  IN  TWO  SLOTS  OF  80 MIN EACH CONSISTING  OF  20 PARTICIPANTS IN EACH SLOT.</li><br><li>
THE  PARTICIPANT  WILL  BE  ALLOTED  60 MIN TO  COMPLETE  THE  TASK.</li><br><li>
THE  TASK  WILL  BE  PROVIDED  ON  SPOT . </li><br><li>
THE  MAXIMUM POINTS  FOR  THE  TASK  WILL  BE  100.</li><br><li>
FOR  EACH  MINUTE  SAVED, PARTICIPANT  WILL BE  AWARDED  WITH  0.5 POINTS.</li><br><li>
FOR  EACH  EXTRA MINUTE, PARTICIPANT WILL  LOOSE  1 POINTS.</li><br><li>
THE  PARTICIPANTS  SHALL  REPORT  TO  THEIR  ALLOTED  SPOT  5 MIN BEFORE  TEST  SO  AS  TO  CONFIRM  THE  EFFECTIVE  WORKING  OF  THEIR  DEVICE.</li><br><li>
THE  PARTICIPANTS  HAVE  TO  SAVE  THEIR  PERFORMED  TASKS  IN THEIR RESPECTIVE  FOLDER  HAVING  THEIR ALLOTED  ID NUMBER.. FOR  THIS  THEY WILL BE ALLOTED 5 MIN EXTRA  AT  THE END.</li><br><li>
ESSENTIAL  PROVISION  SHALL  BE  MADE  BY  THE  ORGANISING  TEAM  IN  CASE OF  OTHER  TECHNICAL  ISSUES .</li><br>
...
<h4>JUDGEMENT</h4><li>
THE  JUDGEMENT  WILL  BE  BASED  ON  ACCURACY  AND  PRECISENESS  SHOWN  IN  THE  TASK  ALLOTED.</li><br><li>
BESIDE THIS,  INCREEMENT  AND  DECREEMENT  WILL  BE  MADE  AS  PER  TIME  CONSUMED.</li><br><li>
IN  CASE  OF  TIE ,  JUDGEMENT  WILL  BE  MADE  ON  THE  BASIS  OF  THE  TIE – BREAKER  QUESTIONS  GIVEN  ALONG  WITH  THE  TASK.</li><br><li>
INDISCIPLINARY  ACT  WILL  BE   PENALISED .</li><br>


</div>
<div class="tab-pane fade" id="tab4">
<h4>REQUIREMENTS</h4><li>
A  WELL EQUIPPED  LAB  WITH  20  NOS.  OF  RUNNING  P.C.</li><br><li>
LIST  OF  PARTICIPANTS  ALONG  WITH  THEIR  PERSONAL DATA.</li><br><li>
CERTIFICATES  OF  APPRECIATIONS  TO  BE  HANDED  TO  THE  WINNING  AND  RUNNER-UP  TEAM.</li><br>
...
<div class="media-body">
<h3 style="color:#fff;margin-left:10px">JAIDEEP MUKHERJEE</h3>

<h4 style="color:#fff;margin-left:10px">Ph no. 8603468669</h4>
...
<!--GRID SECTION END-->
<section id="workshops" style="margin-top:-15%">
<div class="container">
...
$num = mysqli_num_rows(mysqli_query($con,"SELECT * FROM cad"));
echo $num;
 ?>
<small>in this event</small>
</div>
