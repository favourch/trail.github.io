...
<![endif]-->
<title>code of queries|Equilibrio 2k18</title>
...
background:url(parallax/css/images/brain1.png) no-repeat;}
.planet2{
background:url(parallax/css/images/brain2.png) no-repeat;}
    </style>
...
“THE MOST EFFICIENT WAY TO OPTIMIZE A SQL
QUERY IS TO ELIMINATE IT”</br>
There are two types of a software development –
Backend &amp; Frontend. Front-end = what you see;
back-end = how it works. If you’re going to decide
“how it works” you should be a great Database
Administrator, consequently you should be great at
writing SQL queries. So, we&#39;re here with a CODE
THE QUERY event to provide you all a platform to
test your skills in solving SQL QUERIES. </br>&quot; Be a Challenger and take a Challenge to CODE
THE QUERY&quot;.<br>
<h4>Event Format: </h4>
<ul><li>The event consists of two rounds.</li><br>

</ul>
<h4>TEAM SIZE:</h4>
<ul><li>Individual Participation is Allowed.</li><br>
...
<h3>QUIZ ROUND</h3>
<p>
<ol>All Participants need to solve 30
MCQ questions in given 45 min. Quiz round will be based on
offline mode(Pen - Paper Test Type). 20 MCQ questions will
be purely based on basics of SQL (I.e. Both Queries and
fundamentals of SQL). Remaining 10 MCQ questions can be
from basics of database and may also contain some SQL
queries again. Top 10 participants will be selected for 2 nd
round on the merit basis. All questions carry equal marks.</ol></p>
...
<h3>Final round</h3><p>
<ol>Maximum time limit for this
round is 60mins. A separate laptop will be provided to each
participant. System will contain database of multiple tables
on the basis of which Participants need to run 15 Queries
on command prompt. At last some points will be rewarded
for each correct query and on the basis of their early
submission. Ultimately the participant who will score the
highest will be declared as Winner.
</ol>     
</p>
<h3> QUERIES TYPE : </h3>
<ol><li>TYPE A – 10 queries will be based on to apply
LIKE,WHERE,OR,AND,BETWEEN,ORDER BY, GROUP BY, COUNT, MIN MAX ,AVG
(i.e. Some clauses, operators and aggregation functions) on a single given table</li>
<li>TYPE B – 5 Queries will be based on performing joins and writing sub Queries for
multiple tables.</li></ol>
<h3> POINTS SCHEME</h3>
<ol><li>A participant can earn maximum of 500 points</li><li>
5 points will be rewarded for each correct solution for TYPE A Query</li><li>
10 points will be rewarded for each correct solution for TYPE B Query</li><li>
Total points earned by participant will be further multiply by 5,4,3,2,1 on the basis of
their submission time as mentioned below</li></ol>
<ol>0 – 15mins (5x)</br>
15 -30mins (4x)</br>
30 – 40mins (3x)</br>
40 – 50mins (2x)</br>
...
<h2 style="color:#28a351;">Event Coordinator</h2>
<div class="media testimonial-inner">
<div class="pull-left">
<img class="img-responsive img-circle" src="assets/img/team/head/brain.jpg">
</div>
<div class="media-body"><br>
<!--<h3 style="color:#fff;margin-left:10px"> Vishal Kumar</h3>

<h4 style="color:#fff;margin-left:10px">Ph no. 7415758586</h4>-->
</div>
</div>
...
$num = mysqli_num_rows(mysqli_query($con,"SELECT * FROM ctq"));
echo $num;
 ?>
<small>in this event</small>
</div>
...
<a href="#" data-filter=".f2" class="btn btn-custom btn-custom-two btn-sm">F1</a>
...
<div class="col-xs-12 col-sm-4 col-md-4 col-lg-4 f2">
