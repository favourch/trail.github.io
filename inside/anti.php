...
<![endif]-->
<title>AntiEarthquakeStructure|Equilibrio 2k18</title>
...
background:url(parallax/css/images/anti1.png) no-repeat;}
.planet2{
background:url(parallax/css/images/anti2.png) no-repeat;}
    </style>
...
<h3>Anti Earthquake structure</h3>
<hr />
...
<li class=""><a href="#tab3" data-toggle="tab" class="tehnical">Structure Specification </a></li>
...
<p>Here, we have to made such a structure using popsicle sticks & Glue that can not only sustain vertical loading but also can bear the seismic waves produced due to Earthquakes.</p><br>
<h4>Format of Event</h4>
<ol><li>Participants have to make the structure model at the venue of event.
</li><br>
<li>Model should be strong enough to bear vertical load and flexible enough to survive against E-Quake vibrations.

</li><br>
<li>Beside the testing, Team which make the model in less time with required specifications, will have advantage & will gain more points.
</li><br>
<li>There will be 2 TESTs to be conducted on the prepared model.
</li>
...
<p>
<ol><li>
 A team can have a max. of 3 members. </li><br>
<li>Max. 3 hrs. will be provided to make the structure model.</li><br>
<li>Team members must not have to bring any type of items from outside related to the event at the venue.
</li><br>
<li>Each & everything u need will be provided there.</li><br>
<li>All the Participants must follow the Disciplines during the event</li>
...
<p><H3>Specification of Structure</H3>
<ol><li>
The Structure should have minimum 3 storeys.
</li><br>
<li>The minimum height of each storey should be of 15 cm
</li><br>
<li>The overall height of the model should be of 50 cm</li><br>
<li>Side wall should not be completely closed</li><br>
<li>Roof must be covered</li></ol>
</p>
</div>
...
<ul><li>Time of construction</li><li>Sticks used</li></ul>
</li><br>
<li>STAGE: 2 (Qualifying round)
<p>Model should fulfill the following requirements to qualify for the tests to be conducted: </p>
<ul><li>Minimum no. of storey. </li>
<li>Individual floor height</li>
<li>Overall height of model</li>
<li>Side wall. </li>
<li>Roof</li>
</ul>
</li>
<li>STAGE: 3 (Test to be conducted)
<ul>
  <li>VERTICAL LOADING TEST:</li>
  <p>Structure should be strong enough to bear minimum specified VERTICAL LOADING.</p>
  <li>SHAKE IT UP TEST:</li>
  <p>After vertical loading, model will undergo EARTH-QUAKE VIBRATION TEST.</p>
</ul>
</li>
</ol>
<p>Test models are fixed to the platform of SHAKE TABLE and shaken, often to the point of failure.</p>
</p>
</div>
...
<div class="media-body">
<!--<h3 style="color:#fff;margin-left:10px">Rajni</h3>

<h4 style="color:#fff;margin-left:10px">Ph no. 7771986872</h4>-->
</div>
</div>
...
$num = mysqli_num_rows(mysqli_query($con,"SELECT * FROM anti"));
echo $num;
 ?>
<small>in this event</small>
</div>
