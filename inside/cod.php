...
background:url(parallax/css/images/lca1.png) no-repeat;}
.planet2{
background:url(parallax/css/images/lca2.png) no-repeat;}
    </style>-->
...
<li class=""><a href="#tab5" data-toggle="tab" class="tehnical">Registration Fees</a></li>
...
<h4>NO STANDING, ONLY DANCING !!!</h4><br>
<p>The time has come to take out dancing shoes and polish up your moves. This event gives you the platform to show your grace and elegance altogether. <br>Let's create a vibe of Rock n Roll, Bollywood thumkas, Locking Popping, hip hop moves and many more.</p>
...
<div class="media-body">
<h3>ROUND 1</h3><p>
Participants are asked to submit a 2 minutes video of their
dance for elimination round at hospitality desk or at
codequilibrio2k18@gmail.com by 8th Jan 2018.<br><br>
10 solo and 5 group performances will get selected for
the final onstage round.(18 Jan-expected)<br><br>
Teams are free to put up any performance
The performance doesn’t necessarily have to be
thematic.</p>
</div>
</div>
</div>
...
<p>
<h3>ROUND 2</h3><br>
The final decision of winners would be taken by the 3
judges on the aspect of dance steps, expressions, clarity
and costumes.<br>
<ul><h3>
Stage Specifications:</h3>
Closed Auditorium with the audience on one side of
the stage.<br><br>
<h3>Time Limit:</h3>
The performance should not exceeds 10 minutes<br><br>
<h3>Judging Criteria:</h3>
Choreography,Synchronization, Energy,Stage
utilization, Expressions, Costumes, Overall impact</ul>     
</p>
</div>

<div class="tab-pane fade" id="tab4">
<p><H3>RULES</H3>
<ol><li>Participants may use more than one song in their
performance</li><br><li>
The soundtrack should be brought in a pen drive
(in .mp3 format only) during Equilibrio.</li><br><li>
Vulgarity and obscenity at any point is strictly not
allowed. It can lead to immediate disqualification.
Songs to be chosen accordingly.</li><br><li>
Participants cannot perform multiple times.</li><br><li>
Costumes and props must be brought by the
participants themselves.</li><br><li>
Selected participants must be present at the venue
half hour before the starting of event.</li><br><li>
Decision of judges would be final and can’t be
changed.</li>
</ol>
</p>
</div>
...
Participants or Groups shortlisted for Final
round will have to submit registration Fees as
per:<br>
<h4>Solo Performance:</h4><li>
For GGV participant: Rs. 250</li><br><li>
For Non-GGV participant: Rs. 400</li><br>
<h4>Group performance:</h4><li>
For GGV participants: Rs 250 per member</li><br><li>
For Non GGV participants: Rs 400 per member</li><br>
Note: Maximum Registration Fees collected
from a group will be 2000 .<br><li>
For GGV participants: If members in a group is
more than 8</li><br><li>
For Non GGV participants: If members in a
group is more than 5</li>
</div>
...
<h3 style="color:#fff;margin-left:10px">VICKY KUMAR</h3>

<h4 style="color:#fff;margin-left:10px">Ph no. 9430016897</h4>
</div>
</div>
<div class="media testimonial-inner">
<div class="pull-left">
...
<div class="media-body"><br><br>
<h3 style="color:#fff;margin-left:10px">KHUSHBOO</h3>

<h4 style="color:#fff;margin-left:10px">Ph no. 9044897179</h4>
</div>
</div>
...
<section id="workshops" style="margin-left:-20%" >
<div class="container">
...
$num = mysqli_num_rows(mysqli_query($con,"SELECT * FROM cod"));
echo $num;
 ?>
<small>in this event</small>
</div>
