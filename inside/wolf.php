...
<![endif]-->
<title>WOLF OF WALLSTREET|Equilibrio 2k18</title>
...
background:url(parallax/css/images/exposure1.png) no-repeat;}
.planet2{
background:url(parallax/css/images/exposure2.png) no-repeat;}
    </style>-->
...
<p>Wolf of wall street is an online simulation trading game where you create
and manage your own portfolio and compete with other players in a risk-
free environment. Whether you&#39;re new to the stock markets or an
experienced investor, this is a powerful tool for building skill, evaluating
and tuning your strategy, and gaining important investing experience.
Simply buy stocks to build your initial portfolio. Continue to track the
market and keep an shuffle your portfolio to grab opportunities provided
so as to maximize your gains.<BR>
Strategy, and gaining important investing experience. Simply buy stocks
to build your initial portfolio. Continue to track the market and keep an
eye on your portfolio to grab opportunities provided etc. Access financial
information on stocks to get better insight on its potential and
fundamentals.</P>
</div>
</div>
</div>
...
<div class="media-body">
<H3>Round 1: Online Mock Stock</H3>

The teams will be given access to the special mock trading portal for the
event. The teams will be assigned a fixed purse, which they would invest
and trade in various stocks on real-time basis. The teams having the top
portfolio size would be invited on campus for the final round.
</div>
</div>
</div>
<div class="tab-pane fade" id="tab3">
<p>
<H3>Round 2: On Campus</H3>
<br>
<h4>RULES AND REGULATIONS:</h4>
The event is open to all students.<br>
Participants in a team should be from the same institute and no
participant can be a part of more than one team.<br>
Teams should consist of 3 members.<br>
No changes in team composition are allowed after registration.<br>
Teams have to adhere to deadlines for the various rounds failing to which
teams may be disqualified.<br>
Participating teams need to register on the Equilibrio 2k18 Website.
<a>(www.equifest.in)</a><br>
Participants are requested to like the Facebook page of Equilibrio 2k18
for regular updates. <a>(https://www.facebook.com/TheSimerations)</a>
The decisions of the judges/organizers shall be final and binding on all
participants.<br>
The Terms and Conditions of participation are subject to change at any
time without prior notice. The amended Terms and Conditions of entry
will be effective immediately upon being posted on the website. It is the
sole responsibility of the teams to regularly visit the website to read any
changes.
</p>
</div>
...
<div class="media-body">
<h3 style="color:#fff;margin-left:10px">GHANSHYAM SINGH</h3>
<h4 style="color:#fff;margin-left:10px">Ph no. 8319289906</h4>
</div>
    ...
    color: #404040;
                    ...
                    <div class="col-md-6">
                      <label style="color:#e44f4f">Select your Event</label>
                        <div class="input-contact">
                          <select name="event">
                               <option value="wws">WOLF OF WALLSTRETT</option>
...
<section id="workshops" style="margin-top:-10%" >
<div class="container">
...
$num = mysqli_num_rows(mysqli_query($con,"SELECT * FROM wws"));
echo $num;
 ?>
<small>in this event</small>
</div>
