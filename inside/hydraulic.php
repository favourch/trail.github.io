...
<![endif]-->
<title>Hydraulic|Equilibrio 2k17</title>
...
background:url(parallax/css/images/hydraulic1.png) no-repeat;}
.planet2{
background:url(parallax/css/images/hydraulic2.png) no-repeat;}
    </style>
...
<li class=""><a href="#tab3" data-toggle="tab" class="tehnical">Crane Specification</a></li>
<li class=""><a href="#tab4" data-toggle="tab" class="tehnical">Material Used</a></li>
...
<h4>"Engineering is the art of directing the great sources of power in
nature for the use and convenience of human."</h4>
<br>
<p>Hydraulic crane is a device, used for raising or transferring heavy loads.
In this system power is transmitted with the help of a fluid like water or
oil under pressure. <br>Hydraulic cranes work using the concept of
transmitting a force from one point to another point through an
incompressible fluid. Example in real worlds loader crane, mobile
cranes, truck mounted crane, tower crane etc.</p>
...
<div class="media-body">
<h4>GAME PLAY</h4>
<p>Based on the principle of hydraulics you have to design a crane out
of wood, which is capable of lifting sand in its bucket and trans-
Porting it to another location, and be fast because the clock is
ticking. The team with the fastest, most stable and efficient crane
takes away the prize.

</p>
<ol>
  <li>There will be only one round.</li><br>
  <li>Participants have to build a hydraulic crane at their home and
should bring it at the venue of the event.</li><br>
  <li>Crane should be able to lift the sand and place the same on
certain specified position.</li><br>
 <li>Each team will be provided with fixed time interval during
which they have to lift the maximum amount of sand.</li>
</ol>
</div>
</div>
</div>
...
<p><H4>CRANE SPECIFICATION</H4>
<ol><li>Crane must have size of 60cm x 35cm x 40cm(lxbxh).</li><br>
<li>Maximum volume of syringes should be 12ml.</li><br>
<li>The hydraulic crane must contain at least two arms.</li><br>
<li>The hydraulic crane should have minimum of 3 degrees of
freedom.</li><br>
<li>For each degree/type of motion only one pair of syringes
should be used.</li><br>
<li>The crane should rotate at least by 60 degrees in either
direction.</li><br>
</ol>
</p>
</div>
<div class="tab-pane fade" id="tab4">
<p><h4>MATERIAL USED</h4>
<ul><li>Wooden plank.</li>
<li>Syringes</li>
<li>Rubber tube</li>
<li>Lifting arm of crane should be of either wood or fiber.</li>
<li>Scrap materials, nuts, bolts, nails and screws.</li>

</ul><br>
<h5>USE OF ANY TYPE OF METAL STRIP IN CRANE(ARM AND BASE) IS
STRICTLY PROHIBITED.</h5></p>
</div>
...
<div class="media-body">
<h3 style="color:#fff;margin-left:10px">Prabhat Paswan</h3>

<h4 style="color:#fff;margin-left:10px">Ph no. 7024082510</h4>
</div>
</div>
...
$num = mysqli_num_rows(mysqli_query($con,"SELECT * FROM hydraulic"));
echo $num;
 ?>
<small>in this event</small>
</div>
