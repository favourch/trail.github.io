...
<![endif]-->
<title>MINI MILITIA|Equilibrio 2k18</title>
...
<li class=""><a href="#tab3" data-toggle="tab" class="tehnical">Map Pool</a></li>
...
Doodle army 2 mini militia is based on the original stickman shooter doodle army. The game features explosive online and local multiplayer warfare!intuitive dual stick shooting controls. Open world utilising rocket for extended vertical flight. Zoom controls,melee attacks and dual wield ability with modern and futuristic heavy duty weapons and grenades.
<h4>BASIC RULES</h4>
<ul>
...
<p>
<ol><li>
Game mode : Local death match(single and team)</li>
<li>
Time : 6mins 30 secs</li>
<li>
Player should bring his own device.</li>
<li>
The match consists of only one round. The winner of the round will be awarded.</li>
<li>
If once the plater forfeits the match,the player will be disqualified.</li>
<li>
The mini militia app will be provided on spot.</li>

<li>
Any protests or disagreements with game rulings must be made directly to the organiser in a resonable manner at the time of the incident,at which time a prompt decision will be made.</li>
<li>
The organiser decision will be the final decision.</li>
<li>
Any competitor attempting to use any exploit (cracks and hacks)in a map shall be immediately disqualified any may be removed from the event.</li>
<li>
The game organizers reserve the right to cancel or modify the game rules if technical failures or any other factor beyond resonable control,impairs the integrity of the game.</li>
<li>
The winner of the game is decided based on the net points (or no of kills if the net points of two or more players or equal).</li>
...
<p><h3>MAPS</h3>
<ol><li>no escape</li><br>
<li>catacombs</li><br>
 <li>outpost</li><br>
<li>bottle neck</li><br>
 <li>high tower</li><br>
...
<div class="media-body">
<h3 style="color:#fff;margin-left:10px">ABHIJENDRA ANAND</h3>

<h4 style="color:#fff;margin-left:10px">Ph no. 8109233812</h4>
</div>
</div>
    ...
    color: #404040;
                    ...
                    <div class="col-md-6">
                      <label style="color:#e44f4f">Select your Event</label>
                        <div class="input-contact">
                          <select name="event">
                               <option value="mnm">MINI MILITIA</option>
