...
<![endif]-->
<title>Karyaneeti|Equilibrio 2k17</title>
...
<p>Creative thinker, Quick planner<br>
“All things are created twice; first mentally and then physically. The key to creativity begins with the end in mind.”</p>
<br>

<h4>There will be two rounds in the event.</h4><br>
<h4>Maximum no. of member is 3.</h4>
</div>
</div>
</div>
...
<ol>
<li>In the first round, an unknown project will be given to each group. Project will be different for different groups.</li><br>
<li>Some definite capital will be decided for their project by Event Coordinator.</li><br>
<li>Participants will have to prepare a paper project to utilise the   capital provided in an effective way considering cost, quality and time.</li>

</ol><br>
<h4>ROUND 2</h4>
<ol>
<li>From first round best five teams will be selected for second round.</li><br>
<li>5.  Second round will be an interview round in which participants have to explain their project and have to answer the questions asked by the respective judges and event coordinator. </li><br>
<li>In this session participants may be asked to re-plan their project in presence of some constraints provided by the judges.</li><br>
<li>According to their final profit-loss statement winner will be chosen.</li><br>
</ol></div>
</div>
</div>
...
<div class="media-body">
<h3 style="color:#fff;margin-left:10px">Divya Tanu</h3>

<h4 style="color:#fff;margin-left:10px">Ph no. 8544297723</h4>
</div>
</div>
...
$fh1 = fopen("karyaneeti1.txt", 'r+') or
...
$num = mysqli_num_rows(mysqli_query($con,"SELECT * FROM karyaneeti"));
echo $num;
 ?>
<small>in this event</small>
</div>
