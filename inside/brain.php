...
<![endif]-->
<title>BrainWaves|Equilibrio 2k17</title>
...
<h3>“Animosity to the brain teasing questions will sense a different approach from here!!!”</h3><br>
It is a battlefield to test your intelligence, skills and personality.<br>
<h4>Event Format: </h4>
...
<h4>Written Test</h4><br>
<p>
<ul><li>
The written test will include puzzles and mind teasers. It will test your logical thinking ability.</li>
...
<p>
<h4>Based on the preliminary round, 5 teams will be selected for second round.</h4>
<ol><li>All the teams will be presented with one question at a time which they need to answer in the given time.</li><br>
<li>The team answering the question correctly and in the minimum time will be awarded the points</li><br>
<li>After the final round, the team scoring the maximum points will be declared as the winner.</li><br>
</ol>     
</p>
</div>
...
$num = mysqli_num_rows(mysqli_query($con,"SELECT * FROM brain"));
echo $num;
 ?>
<small>in this event</small>
</div>
