...
background:url(parallax/css/images/codesense1.png) no-repeat;}
.planet2{
background:url(parallax/css/images/codesense2.png) no-repeat;}
    </style>-->
...
<li class=""><a href="#tab4" data-toggle="tab" class="tehnical">Timing</a></li>
...
<ol><li> The contest will have a total of five programming questions of varying difficulty.</li><br><li> The problems will be based on Basic Mathematics, Data Structures and Algorithms. </li><br>
...
<div class="media-body">
<h3 style="color:#fff;margin-left:10px">Sandeep Ku. Verma</h3>

<h4 style="color:#fff;margin-left:10px">Ph no. 7089718773</h4>
</div>
</div>
                      ...
                      <label style="color:#e44f4f">Select your Event</label>
                        <div class="input-contact">
                          <select name="event">
                             ...
                             <option value="cds">CodeSense</option>
...
$num = mysqli_num_rows(mysqli_query($con,"SELECT * FROM cds"));
echo $num;
 ?>
<small>in this event</small>
</div>
