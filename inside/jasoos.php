...
<![endif]-->
<title>Jasoos Engineer|Equilibrio 2k18</title>
...
<li class="active"><a href="#tab1" data-toggle="tab" class="analistic-01">About</a></li>
<li><a href="#tab2" data-toggle="tab" class="analistic-02">Rules</a></li>
<li><a href="#tab3" data-toggle="tab" class="analistic-02">Judging Criteria</a></li>
...
<h4>About</h4>
<p><ol>Due to lack of knowledge about surrounding nature, concept of materials and architectural mistakes,the failure in structures take place. <br>
It is essential to have in depth knowledge in order to detect problems on spot and eradicate engineering disasters.<br>
...
.<br><br>2-questions will be provided online on ‘Equilibrio’s website 11 days before event.<br>
Particepents have to make power point presentation on given questions,giving suitable solutions for the problems.</ol></p>
...
<div class="media-body">
<h4> Rule:-
<li>The event is open to all and Online , only have to send PPT of solution on given mail-id.</li><br>
<li>Maximum team member will be 2.</li><br>
<li>The teams can present their investigation report (in the form of Power Point Presentation) during event if possible , It is not mandatory .</li><br>
<li>The decision of judges will be final.</li><br>

<li>certificate of participation will be provided if he attempts both questions.</div>
</div>
</div>
...
<li>
The presentation will be evaluated by the judges on the basis of content, relevancy,and accuracy.</li>
...
<div class="media-body">
<h3 style="color:#fff;margin-left:10px">pradyuman rakhecha</h3>

<h4 style="color:#fff;margin-left:10px">Ph no. 7728066771</h4>
...
$num = mysqli_num_rows(mysqli_query($con,"SELECT * FROM jso"));
echo $num;
 ?>
<small>in this event</small>
</div>
