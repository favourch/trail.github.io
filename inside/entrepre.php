...
<![endif]-->
<title>StartupMania|Equilibrio 2k18</title>
...
<li class=""><a href="#tab3" data-toggle="tab" class="tehnical">Judging Criteria</a></li>
...
<h5 style="text-align:right">- Steve Jobs</h5><br>
<p>This era of business belongs to the entrepreneurs. Following your own instincts rather than following others is the sole mantra of entrepreneurship. So this event as the name suggests is an event wherein you can showcase your idea or plan (basically startup ideas) whereby based on the criteria mentioned below winners will be declared and if possible the ideas can be showcased or presented before angel investors or venture capitalists. </p><br>
<h4>Team size : Maximum number of members is 4</h4>
</div>
</div>
</div>
...
<h4>ROUND 1</h4>
<p>
All participating teams will submit an abstract of max. 250-300 words giving basic overview of the plan which is to be mailed before <strong>15 JAN 2017</strong> to <strong>itisingh073@gmail.com</strong>
</p><br>
...
<br><h4>40% - quality of startup plan </h4>
<ol><li>Market need of product or services.</li>
<li>Market potential for your product.</li>
<li>Financial forecasts.</li>
<li>Competitive advantages.</li>
</ol><br>
<h4>40 % - impact of presentation.</h4>     
<ol><li>Provide evidence of a market.</li>
<li>Provide evidence of ability to execute.</li>
<li>Provide evidence of a return on investment.</li>

</ol><br>
<h4>20% - judges assessment of idea potential</h4> 
</p>
</div>
...
<div class="media-body">
<!--<h3 style="color:#fff;margin-left:10px">Itti Singh</h3>
<h4 style="color:#fff;margin-left:10px">Ph no. 9685611799</h4>-->
</div>
</div>
    ...
    color: #404040;
                    ...
                    <div class="col-md-6">
                      <label style="color:#e44f4f">Select your Event</label>
                        <div class="input-contact">
                          <select name="event">
                               <option value="ent">ENTREPRENURIAL SKILL QUOTINT</option>
...
$num = mysqli_num_rows(mysqli_query($con,"SELECT * FROM ent"));
echo $num;
 ?>
<small>in this event</small>
</div>
