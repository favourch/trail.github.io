...
<![endif]-->
<title>PetBottle|Equilibrio 2k17</title>
...
background:url(parallax/css/images/petbottle1.png) no-repeat;}
.planet2{
background:url(parallax/css/images/petbottle2.png) no-repeat;}
    </style>
...
<p>PET BOTTLE ROCKET is an event involving basic engineering knowledge and hence students of all branches can participate. It is an interesting event, has simple design, easy to construct & is less expensive.<br>The purpose of organising this event is to provide the information related to TIME OF FLIGHT & RANGE obtained by model of rocket. These useful information are used for dimensional analysis of prototype.<br><br>
...
<ol>
<li>
First round is a qualifying round. 
</li><br>
<li>In this round, Distance is the qualification criterion which is 50 meter. </li><br>
<li>Single point is given for every meter .
</li><br>
<li>30% Weightage for First round</li><br>
...
<p><h4>Round 2</h4>
<ol>
<li>Second round is final round.</li><br>
<li>This round is focused on time of flight.</li><br>
<li>Five points are
given for every second.
</li><br>
<li>70% Weightage for 2nd Round.</li><br>
</ol>   
</p>
</div>
...
<div class="pull-left">
<img class="img-responsive img-circle" src="assets/img/team/head/pet.jpg">
</div>
<div class="media-body"><br>
<h3 style="color:#fff;margin-left:10px">ABHASH VERMA  </h3>

<h4 style="color:#fff;margin-left:10px">Ph no. 7694855832</h4>
</div>
</div>
...
$num = mysqli_num_rows(mysqli_query($con,"SELECT * FROM petbottle"));
echo $num;
 ?>
<small>in this event</small>
</div>
