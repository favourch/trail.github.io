...
<h3 style="color:#fff;margin-left:10px">UTKARSH PATEL</h3>

<h4 style="color:#fff;margin-left:10px">Ph.no 9993600319</h4>
</div>
</div>
...
$num = mysqli_num_rows(mysqli_query($con,"SELECT * FROM ptb"));
echo $num;
 ?>
<small>in this event</small>
</div>
