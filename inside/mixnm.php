...
<![endif]-->
<title>Mix N Match|Equilibrio 2k18</title>
...
<li class=""><a href="#tab5" data-toggle="tab" class="tehnical">REGISTRATION FEE</a></li>-->
...
"Girls and boys be ready to put the stage on fire with your walk sand talks...pin up your best
clothes and comeup to the ramp..showy our style and atitude to the judges and grab our the
prizes...we warmly welcome all the youths for the fashionshow 2018..."
<br><br>
EVERYDAY IS A FASHION SHOW AND THE WORLD IS THE RUNWAY..SO SHOW IT..!!!..GRAB
IT..!!..AND BANGON.!!!
<br><br>HURRY UP HERE'S THE OPPORTUNITY
</div>
</div>
</div>
...
<h4>Round 1</h4>
<p>
<ol>50 candidates (25-25for each boys and girls) are shortlisted from the registered candidates..
<br>Selection will be based on the pictures and aptitude question..
<br>Candidates are asked to submit there two full length pictures to the undersigned mail id for the
selection procedure.
<br>And aptitude question paper will be available with your registration for monly
<h3>NOTE</h3><p><li>
PICTURES MUST BE CLICKED BY NORMAL CAMERA.NO EDITING APP MUST BE USED(WITHIN
8-13 PIXELS CAMERA)</li><br><li>
ANY OTHER METHODS IS NOT PERMITTED  FOR THE PHOTOS.AND BE STRICT ABOUT THE
NOTE BECAUSE ALL THE PHOTOS WILL BE SHORT LISTED BY A PHOTOGRAPHER.</li><br><li>
QUESTIONS FOR THE APTITUDE ROUND WILL BE BASED ONLY ON TRICKS.</li><br><li>
NO SUBJECTIVE QUESTIONS WILL BE THERE.ITS ONLY BASD ON REASONING.</li><br><li>
MULTIPLE OPTIONS WILL BE PROVIDED AND CANDIDATES HAVE TO CHOOSE AMONG THEM.</p><br><br>
EX.Ques..How can two heads,six legs,and a tail move fast..?<br>
...
<p>
<h4>Round 2</h4><br>
ITS A RUNWAY CHALLENGE.<br>
A TWO MINUTE WALK ON THE STAGE WITH THERE ATITRE AND PROPER PRESENTATION OF THE
PROP.<br><br>
DESCRIBE YOURSELF WITH YOUR THEME.<br>
ANSWER TO THE JUDGES QUESTIONS ABOUT THE REPERSONAL LIFES AND HYPOTHETICAL
SITUATIONS.<br><br>
FINAL SELECTION WILL BE ON YOUR OWN PERFORMANCE ONTAGE.<br><br>
<hh>Props lists:</h4><br>
A Umbrella, Astick, Any bag, A book, Sun glasses, Flowers, A mini paper fan, Hair dryers or
rollers, Make up brush, Feathers or wings, Towels, Balls, Baloons, Antique frame, Guitars, Chair.
</div>
<div class="tab-pane fade" id="tab4">
<h4>RULES AND REGULATIONS</h4>
 Anabstract (theme description)not exceeding more than 20words.<br>
 Use of prop is mandatory.(list of propsare given in the next page.Students have to
select from any one of them.)<br>
 Selection of theme is optional.<br>
 Each participant will get just 3 min for their walk.<br>
 Participants have to carry their own inventories (costumes, cosmetics and presentation
will be their own).<br>
 The judgement of the jury will be final and abide.<br>
 Exceeding time limit will lead to negative points.<br>
 Any obscenity on stage will lead to immediate disqualification.<br>
 Vulgarity is strictly prohibited.<br>
 Use of cigarettes, alcohol or any unfairmeans is strongly prohibited.<br>
 No extra exposeness will be permissible.<br>
 Use of wrongs words and cheap language on the show is not allowed.<br><br>
<h4>JUDGING CRITERIA:</h4>
 theme justification<br>
 makeup & Attire<br>
...
<div class="media-body">
<h3 style="color:#fff;margin-left:10px">RIA MALLIK</h3>

<h4 style="color:#fff;margin-left:10px">Ph no. 7389407886</h4>
</div>
</div>
...
$num = mysqli_num_rows(mysqli_query($con,"SELECT * FROM mnm"));
echo $num;
 ?>
<small>in this event</small>
</div>
