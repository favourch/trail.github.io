...
<![endif]-->
<title>CodeBid|Equilibrio 2k18</title>
...
background:url(parallax/css/images/codebid1.png) no-repeat;}
.planet2{
background:url(parallax/css/images/codebid2.png) no-repeat;}
    </style>
...
<li class=""><a href="#tab4" data-toggle="tab" class="tehnical">Credit System</a></li>
...
<h4>You don’t enjoy coding. Believe us, after this you will.<br><br>
 “It's the game of life. Do I win or do I lose? One day they're gonna shut the game down. I gotta have as much fun and go around the board as many times as I can before it's my turn to leave.”   </h4><br>
<h4>Event Format: </h4>
<ul><li>The event consists of two rounds.</li><br>

</ul>
<h4>TEAM SIZE:</h4>
<ul><li> Maximum number of members 2.</li><br>
...
<div class="media-body">
<h3>MOONSHOT ROUND</h3>
<p>
<Ol><li>
The written test will include questions on basic C/C++, logic, pattern recognition, basic programming concepts and program analysis. </li><br>
<li>The Test will be of half an hour. </li><br>
<li>Based on this round maximum 10 teams will be shortlisted for the second round. </li><br>
<li>There will reservation for one top team from 1st year and 2nd year each in heart-break round.</li></Ol>
...
<h4>HEART-BREAK ROUND</h4><p>
<ol><li>The second round will be of 2 hour. </li><br>
<li>Each team will be provided with 1000 credits at the starting of the second round.</li><br>
<li>Each question contains a particular no. of credit, based on its complexity.</li><br>
<li>Four team with the lowest time will get the chance to solve the
    question in each bid.
</li><br>
<li>A team can get a loan of 200 credit only once, 250 credit will be
...
<p><h3>CREDIT SYSTEM</h3><br>
<ol><li>If a team gives a correct answer, make a bid of x credits earn x credits. </li><br>
  <li>If a team gives an incorrect answer, make a bid of x credits earn –x  credits.
</li>
</ol>
</p>
</div>
...
<div class="pull-left">
<img class="img-responsive img-circle" src="assets/img/team/head/roy.jpg">
</div>
<div class="media-body">
<h3 style="color:#fff;margin-left:10px"> Saurabh Roy </h3>

<h4 style="color:#fff;margin-left:10px">Ph no. 7582899129</h4>
...
<div class="media-body">
<h3 style="color:#fff;margin-left:10px">Piyush Kumar </h3>

<h4 style="color:#fff;margin-left:10px">Ph no. 7828592132</h4>
...
$num = mysqli_num_rows(mysqli_query($con,"SELECT * FROM codebid"));
echo $num;
 ?>
<small>in this event</small>
</div>
